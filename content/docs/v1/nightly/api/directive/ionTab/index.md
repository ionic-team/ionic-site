...
<a href='https://github.com/ionic-team/ionic-v1/blob/master/js/angular/directive/tab.js#L1'>
View Source
</a>
&nbsp;
<a href='http://github.com/ionic-team/ionic/edit/1.x/js/angular/directive/tab.js#L1'>
Improve this doc
</a>
</div>
...
<br />
<small>
Child of <a href="/docs/v1/nightly/api/directive/ionTabs/"><code>ionTabs</code></a>
</small>
...
```
For a complete, working tab bar example, see the <a href="/docs/v1/nightly/api/directive/ionTabs/"><code>ionTabs</code></a> documentation.
...
<table class="table" style="margin:0;">
  ...
  <code>expression</code>
      ...
      <td>
        <p>By default, the tab will be selected on click. If ngClick is set, it will not.  You can explicitly switch tabs using <a href="/docs/v1/nightly/api/service/$ionicTabsDelegate/#select">$ionicTabsDelegate.select()</a>.</p>

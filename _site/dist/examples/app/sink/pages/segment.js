...
export class SegmentPage {
  constructor() {
    ...
    this.form = new ControlGroup({"mapStyle": this.mapStyle});
  }
}
Object.defineProperty(SegmentPage, "annotations", {get: function() {
    return [new Component({selector: 'ion-view'}), new IonicView({
      template: `

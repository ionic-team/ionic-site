...
export var View_ApiDemoPage0 = (function (_super) {
    ...
    View_ApiDemoPage0.prototype.createInternal = function (rootSelector) {
        ...
        this._el_11 = import84.createRenderElement(this.renderer, null, 'button', new import84.InlineArray4(4, 'block', '', 'ion-button', ''), null);
        this.compView_11 = new import103.View_Button0(this.viewUtils, this, 11, this._el_11);
        this._Button_11_3 = new import103.Wrapper_Button('', this.parentView.injectorGet(import67.Config, this.parentIndex), new import93.ElementRef(this._el_11), this.renderer);
        ...
        this._el_14 = import84.createRenderElement(this.renderer, null, 'button', new import84.InlineArray4(4, 'block', '', 'ion-button', ''), null);
        ...
        this._el_17 = import84.createRenderElement(this.renderer, null, 'button', new import84.InlineArray4(4, 'block', '', 'ion-button', ''), null);
        ...
        this._el_20 = import84.createRenderElement(this.renderer, null, 'button', new import84.InlineArray8(6, 'block', '', 'ion-button', '', 'margin-bottom', ''), null);
        ...
        this._el_23 = import84.createRenderElement(this.renderer, null, 'button', new import84.InlineArray4(4, 'block', '', 'ion-button', ''), null);
        ...
        this._el_26 = import84.createRenderElement(this.renderer, null, 'button', new import84.InlineArray4(4, 'block', '', 'ion-button', ''), null);
        ...
        var disposable_0 = import84.subscribeToRenderElement(this, this._el_11, new import84.InlineArray2(2, 'click', null), this.eventHandler(this.handleEvent_11));
        var disposable_1 = import84.subscribeToRenderElement(this, this._el_14, new import84.InlineArray2(2, 'click', null), this.eventHandler(this.handleEvent_14));
        var disposable_2 = import84.subscribeToRenderElement(this, this._el_17, new import84.InlineArray2(2, 'click', null), this.eventHandler(this.handleEvent_17));
        var disposable_3 = import84.subscribeToRenderElement(this, this._el_20, new import84.InlineArray2(2, 'click', null), this.eventHandler(this.handleEvent_20));
        var disposable_4 = import84.subscribeToRenderElement(this, this._el_23, new import84.InlineArray2(2, 'click', null), this.eventHandler(this.handleEvent_23));
        var disposable_5 = import84.subscribeToRenderElement(this, this._el_26, new import84.InlineArray2(2, 'click', null), this.eventHandler(this.handleEvent_26));
    ...
    View_ApiDemoPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import102.Button) && ((11 <= requestNodeIndex) && (requestNodeIndex <= 12)))) {
        ...
        if (((token === import100.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 28)))) {

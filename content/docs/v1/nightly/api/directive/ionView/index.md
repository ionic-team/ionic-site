...
&nbsp;
<a href='http://github.com/ionic-team/ionic/edit/1.x/js/angular/directive/view.js#L1'>
Improve this doc
</a>
</div>
...
<br />
<small>
Child of <a href="/docs/v1/nightly/api/directive/ionNavView/"><code>ionNavView</code></a>
</small>
...
enters and exits its parent <a href="/docs/v1/nightly/api/directive/ionNavView/"><code>ionNavView</code></a>, the view also emits view
information, such as its title, whether the back button should be displayed or not, whether the
corresponding <a href="/docs/v1/nightly/api/directive/ionNavBar/"><code>ionNavBar</code></a> should be displayed or not, which transition the view
...
views changed in <a href="/docs/v1/nightly/api/provider/$ionicConfigProvider/"><code>$ionicConfigProvider</code></a>, in the view's `$state` configuration, or
...
Below is an example where our page will load with a <a href="/docs/v1/nightly/api/directive/ionNavBar/"><code>ionNavBar</code></a> containing
...
_Caching_ section in <a href="/docs/v1/nightly/api/directive/ionNavView/"><code>ionNavView</code></a> for more info.
...
<table class="table" style="margin:0;">
  ...
  <code>string</code>
      ...
      <td>
        <p>A text-only title to display on the parent <a href="/docs/v1/nightly/api/directive/ionNavBar/"><code>ionNavBar</code></a>.
For an HTML title, such as an image, see <a href="/docs/v1/nightly/api/directive/ionNavTitle/"><code>ionNavTitle</code></a> instead.</p>
...
Please see the <em>Caching</em> section in <a href="/docs/v1/nightly/api/directive/ionNavView/"><code>ionNavView</code></a> for
...
<a href="/docs/v1/nightly/api/directive/ionNavBar/"><code>ionNavBar</code></a> by default.</p>

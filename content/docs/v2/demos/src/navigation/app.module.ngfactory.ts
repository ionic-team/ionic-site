...
export class View_ApiDemoPage0 extends import82.AppView<import1.ApiDemoPage> {
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import100.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 13)))) { return this._Content_9_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    if (!throwOnChange) { if ((this.numberOfChecks === 0)) { this._Button_11_3.context.ngAfterContentInit(); } }
...
export class View_PushPage0 extends import82.AppView<import1.PushPage> {
  ...
  createInternal(rootSelector:string):import88.ComponentRef<any> {
    ...
    this.compView_11.create(this._Button_11_3.context);
    this._text_13 = this.renderer.createText((null as any),'\n  ',(null as any));
    this._el_14 = import84.createRenderElement(this.renderer,(null as any),'button',new import84.InlineArray8(6,'block','','color','secondary','ion-button',''),(null as any));
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_14_0_1:any = 'secondary';
    ...
    this._Navbar_2_3.checkHost(this,this.compView_2,this._el_2,throwOnChange);
    const currVal_29:any = import84.inlineInterpolate(1,'Page ',this.context.pageNum,'');

System.register('rxjs/src/observables/ErrorObservable', ['../Observable'], function (_export) {
    'use strict';

    var Observable, ErrorObservable;
    ...
    return {
        ...
        execute: function () {
            ErrorObservable = (function (_Observable) {
                _inherits(ErrorObservable, _Observable);

                function ErrorObservable(error, scheduler) {
                    _classCallCheck(this, ErrorObservable);

                    _get(Object.getPrototypeOf(ErrorObservable.prototype), 'constructor', this).call(this);
                    this.error = error;
            ...
            _export('default', ErrorObservable);
        }
    };
});
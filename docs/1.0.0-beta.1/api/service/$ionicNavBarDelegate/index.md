...
Set whether the <a href="/docs/api/directive/ionNavBackButton"><code>ionNavBackButton</code></a> should be shown
(if it exists).
...
Set whether the <a href="/docs/api/directive/ionNavBar"><code>ionNavBar</code></a> should be shown.

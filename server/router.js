...
module.exports = function router(app) {
  ...
  .get('/creator', (_, res) => res.render('pro/creator/index'))
  .get('/creator/pricing', (_, res) => res.render('pro/creator/pricing'))
  .get('/creator/support', (_, res) => res.render('pro/creator/support'))

...
&nbsp;
<a href='https://github.com/ionic-team/ionic-v1/edit/master/js/angular/service/sideMenuDelegate.js#L1'>
Improve this doc
</a>
</div>
...
Delegate for controlling the <a href="/docs/v1/api/directive/ionSideMenus/"><code>ionSideMenus</code></a> directive.

Methods called directly on the $ionicSideMenuDelegate service will control all side
menus.  Use the <a href="/docs/v1/api/service/$ionicSideMenuDelegate/#$getByHandle">$getByHandle</a>
...
<a href="/docs/v1/api/directive/ionSideMenus/"><code>ionSideMenus</code></a> directives with `delegate-handle` matching
the given handle.

...
var _View_ApiDemoPage0 = (function (_super) {
    ...
    _View_ApiDemoPage0.prototype.createInternal = function (rootSelector) {
        ...
        this._appEl_0 = new import2.AppElement(0, null, this, this._el_0);
        var compView_0 = import12.viewFactory_Slides0(this.viewUtils, this.injector(0), this._appEl_0);
    ...
    _View_ApiDemoPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import11.NgFor) && (2 === requestNodeIndex))) {
            return this._NgFor_2_6;
        }
        if (((token === import10.Slides) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 3)))) {
...
export function viewFactory_ApiDemoPage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_ApiDemoPage === null)) {
        (renderType_ApiDemoPage = viewUtils.createRenderComponentType('/home/ubuntu/ionic/demos/src/slides/page.html', 0, import8.ViewEncapsulation.None, styles_ApiDemoPage, {}));
    }
...
var _View_ApiDemoPage1 = (function (_super) {
    ...
    _View_ApiDemoPage1.prototype.createInternal = function (rootSelector) {
        ...
        this._appEl_0 = new import2.AppElement(0, null, this, this._el_0);
        var compView_0 = import12.viewFactory_Slide0(this.viewUtils, this.injector(0), this._appEl_0);
        this._Slide_0_4 = new import10.Slide(new import14.ElementRef(this._el_0), this.parent._Slides_0_4);
    ...
    _View_ApiDemoPage1.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import10.Slide) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 3)))) {
...
var _View_ApiDemoApp0 = (function (_super) {
    ...
    _View_ApiDemoApp0.prototype.createInternal = function (rootSelector) {
        ...
        this._Nav_0_4 = new import18.Nav(this.parentInjector.get(import20.ViewController, null), this.parentInjector.get(import21.NavControllerBase, null), this.parentInjector.get(import22.App), this.parentInjector.get(import13.Config), this.parentInjector.get(import23.Keyboard), new import14.ElementRef(this._el_0), this.parentInjector.get(import24.NgZone), this.renderer, this.parentInjector.get(import25.ComponentFactoryResolver), this.parentInjector.get(import26.GestureController), this.parentInjector.get(import27.TransitionController), this.parentInjector.get(import28.DeepLinker, null));
    ...
    _View_ApiDemoApp0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import18.Nav) && (0 === requestNodeIndex))) {
...
export function viewFactory_ApiDemoApp0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_ApiDemoApp === null)) {
        (renderType_ApiDemoApp = viewUtils.createRenderComponentType('/home/ubuntu/ionic/demos/src/slides/app.component.ts class ApiDemoApp - inline template', 0, import8.ViewEncapsulation.None, styles_ApiDemoApp, {}));
    }

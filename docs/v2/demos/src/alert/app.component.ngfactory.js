...
var _View_ApiDemoPage_Host0 = (function (_super) {
    ...
    _View_ApiDemoPage_Host0.prototype.createInternal = function (rootSelector) {
        ...
        this._ApiDemoPage_0_4 = new import3.ApiDemoPage(this.parentInjector.get(import8.AlertController));
...
var _View_ApiDemoPage0 = (function (_super) {
    ...
    _View_ApiDemoPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import14.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 25)))) {
    ...
    _View_ApiDemoPage0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        if (import4.checkBinding(throwOnChange, this._expr_7, currVal_7)) {
            this._Button_14_4.color = currVal_7;
            changed = true;
        ...
        if (import4.checkBinding(throwOnChange, this._expr_9, currVal_9)) {
            this._Button_17_4.block = currVal_9;
            changed = true;
            this._expr_9 = currVal_9;
        }
        var currVal_10 = 'secondary';
        if (import4.checkBinding(throwOnChange, this._expr_10, currVal_10)) {
            this._Button_17_4.color = currVal_10;
            changed = true;
        ...
        if (import4.checkBinding(throwOnChange, this._expr_12, currVal_12)) {
            this._Button_20_4.block = currVal_12;
            changed = true;
            this._expr_12 = currVal_12;
        }
        var currVal_13 = 'danger';
        if (import4.checkBinding(throwOnChange, this._expr_13, currVal_13)) {
            this._Button_20_4.color = currVal_13;
            changed = true;
        ...
        if (import4.checkBinding(throwOnChange, this._expr_15, currVal_15)) {
            this._Button_23_4.block = currVal_15;
            changed = true;
            this._expr_15 = currVal_15;
        }
        var currVal_16 = 'dark';
        if (import4.checkBinding(throwOnChange, this._expr_16, currVal_16)) {
            this._Button_23_4.color = currVal_16;
            changed = true;
...
export function viewFactory_ApiDemoPage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_ApiDemoPage === null)) {
        (renderType_ApiDemoPage = viewUtils.createRenderComponentType('/home/ubuntu/ionic/demos/src/alert/page.html', 0, import9.ViewEncapsulation.None, styles_ApiDemoPage, {}));
    }
...
export function viewFactory_ApiDemoApp0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_ApiDemoApp === null)) {
        (renderType_ApiDemoApp = viewUtils.createRenderComponentType('/home/ubuntu/ionic/demos/src/alert/app.component.ts class ApiDemoApp - inline template', 0, import9.ViewEncapsulation.None, styles_ApiDemoApp, {}));
    }

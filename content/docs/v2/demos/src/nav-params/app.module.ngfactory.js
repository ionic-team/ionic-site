...
export var View_ApiDemoPage0 = (function (_super) {
    ...
    View_ApiDemoPage0.prototype.createInternal = function (rootSelector) {
        ...
        this._el_11 = import85.createRenderElement(this.renderer, null, 'ion-list', new import85.InlineArray2(2, 'no-margin', ''), null);
        ...
        this._el_21 = import85.createRenderElement(this.renderer, null, 'ion-select', new import85.InlineArray2(2, 'multiple', 'true'), null);
        ...
        this._el_23 = import85.createRenderElement(this.renderer, null, 'ion-option', new import85.InlineArray2(2, 'value', 'Bangkok'), null);
        ...
        this._el_26 = import85.createRenderElement(this.renderer, null, 'ion-option', new import85.InlineArray2(2, 'value', 'Nonthaburi'), null);
        ...
        this._el_29 = import85.createRenderElement(this.renderer, null, 'ion-option', new import85.InlineArray2(2, 'value', 'Nakhon Ratchasima'), null);
        ...
        this._el_32 = import85.createRenderElement(this.renderer, null, 'ion-option', new import85.InlineArray2(2, 'value', 'Chiang Mai'), null);
        ...
        this._el_38 = import85.createRenderElement(this.renderer, null, 'div', new import85.InlineArray2(2, 'padding', ''), null);
        this._text_39 = this.renderer.createText(this._el_38, '\n    ', null);
        this._el_40 = import85.createRenderElement(this.renderer, this._el_38, 'button', new import85.InlineArray8(6, 'block', '', 'color', 'secondary', 'ion-button', ''), null);
        ...
        var disposable_1 = import85.subscribeToRenderElement(this, this._el_40, new import85.InlineArray2(2, 'click', null), this.eventHandler(this.handleEvent_40));
    ...
    View_ApiDemoPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import109.Select) && ((21 <= requestNodeIndex) && (requestNodeIndex <= 34)))) {
            return this._Select_21_3.context;
        }
        if (((token === import122.NG_VALUE_ACCESSOR) && ((21 <= requestNodeIndex) && (requestNodeIndex <= 34)))) {
            return this._NG_VALUE_ACCESSOR_21_4;
        }
        if (((token === import123.NgModel) && ((21 <= requestNodeIndex) && (requestNodeIndex <= 34)))) {
            return this._NgModel_21_5.context;
        }
        if (((token === import124.NgControl) && ((21 <= requestNodeIndex) && (requestNodeIndex <= 34)))) {
            return this._NgControl_21_6;
        }
        if (((token === import125.NgControlStatus) && ((21 <= requestNodeIndex) && (requestNodeIndex <= 34)))) {
            return this._NgControlStatus_21_7.context;
        }
        if (((token === import104.Item) && ((16 <= requestNodeIndex) && (requestNodeIndex <= 35)))) {
            return this._Item_16_3.context;
        }
        if (((token === import104.ItemContent) && ((16 <= requestNodeIndex) && (requestNodeIndex <= 35)))) {
            return this._ItemContent_16_4.context;
        }
        if (((token === import126.List) && ((11 <= requestNodeIndex) && (requestNodeIndex <= 36)))) {
            return this._List_11_3.context;
        }
        if (((token === import114.Button) && ((40 <= requestNodeIndex) && (requestNodeIndex <= 41)))) {
            return this._Button_40_3.context;
        }
        if (((token === import101.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 43)))) {
    ...
    View_ApiDemoPage0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        var currVal_21_1_0 = this.context.myParam;
        ...
        var currVal_29_0_0 = 'Nakhon Ratchasima';
        ...
        var currVal_40_0_1 = 'secondary';
        this._Button_40_3.check_color(currVal_40_0_1, throwOnChange, false);
        if (this._Button_40_3.ngDoCheck(this, this._el_40, throwOnChange)) {
        ...
        if (!throwOnChange) {
            ...
            if ((this.numberOfChecks === 0)) {
                this._Button_40_3.context.ngAfterContentInit();
            }
        }
    ...
    View_ApiDemoPage0.prototype.handleEvent_40 = function (eventName, $event) {
        ...
        var result = true;
        if ((eventName == 'click')) {
            var pd_sub_0 = (this.context.pushParams() !== false);
            result = (pd_sub_0 && result);
        }
        return result;
    };
...
export var View_PushPage0 = (function (_super) {
    ...
    View_PushPage0.prototype.createInternal = function (rootSelector) {
        ...
        this._text_7 = this.renderer.createText(this._el_0, '\n\n', null);
        this._text_8 = this.renderer.createText(parentRenderNode, '\n\n\n', null);
        this._el_9 = import85.createRenderElement(this.renderer, parentRenderNode, 'ion-content', new import85.InlineArray2(2, 'padding', ''), null);
        this.compView_9 = new import102.View_Content0(this.viewUtils, this, 9, this._el_9);
        this._Content_9_3 = new import102.Wrapper_Content(this.parentView.injectorGet(import68.Config, this.parentIndex), new import94.ElementRef(this._el_9), this.renderer, this.parentView.injectorGet(import12.App, this.parentIndex), this.parentView.injectorGet(import37.Keyboard, this.parentIndex), this.parentView.injectorGet(import59.NgZone, this.parentIndex), this.parentView.injectorGet(import92.ViewController, this.parentIndex, null), this.parentView.injectorGet(import117.Tabs, this.parentIndex, null), this.parentView.injectorGet(import10.DomController, this.parentIndex));
        this._text_10 = this.renderer.createText(null, '\n\n  ', null);
        this._el_11 = import85.createRenderElement(this.renderer, null, 'div', import85.EMPTY_INLINE_ARRAY, null);
        this._text_12 = this.renderer.createText(this._el_11, '\n    ', null);
        this._el_13 = import85.createRenderElement(this.renderer, this._el_11, 'h5', import85.EMPTY_INLINE_ARRAY, null);
        this._text_14 = this.renderer.createText(this._el_13, 'Parameters passed:', null);
        this._text_15 = this.renderer.createText(this._el_11, '\n\n    ', null);
        this._el_16 = import85.createRenderElement(this.renderer, this._el_11, 'pre', new import85.InlineArray2(2, 'style', 'background-color: #f8f8f8'), null);
    ...
    View_PushPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import101.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 19)))) {
            return this._Content_9_3.context;
        }
        return notFoundResult;
    };
    View_PushPage0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        this._Navbar_2_3.checkHost(this, this.compView_2, this._el_2, throwOnChange);
        this._Content_9_3.checkHost(this, this.compView_9, this._el_9, throwOnChange);
        var currVal_28 = import85.inlineInterpolate(1, 'selections: [\n  ', this.context.myParam, '\n]');

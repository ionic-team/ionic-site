System.register('rxjs/src/operators/reduce', ['../Subscriber', '../util/tryCatch', '../util/errorObject'], function (_export) {
    'use strict';

    var Subscriber, tryCatch, errorObject, ReduceOperator, ReduceSubscriber;
    ...
    return {
        ...
        execute: function () {
            ...
            ReduceSubscriber = (function (_Subscriber) {
                ...
                function ReduceSubscriber(destination, project, acc) {
                    ...
                    _get(Object.getPrototypeOf(ReduceSubscriber.prototype), 'constructor', this).call(this, destination);
                    this.hasValue = false;
                    this.acc = acc;
                    this.project = project;

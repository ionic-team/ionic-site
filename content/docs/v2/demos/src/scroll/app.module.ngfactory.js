...
export var View_ApiDemoPage0 = (function (_super) {
    ...
    View_ApiDemoPage0.prototype.createInternal = function (rootSelector) {
        ...
        this._el_11 = import85.createRenderElement(this.renderer, null, 'ion-scroll', new import85.InlineArray8(6, 'scrollX', 'true', 'scrollY', 'true', 'style', 'width: 100%; height: 100%'), null);
        this.compView_11 = new import104.View_Scroll0(this.viewUtils, this, 11, this._el_11);
        this._Scroll_11_3 = new import104.Wrapper_Scroll(new import94.ElementRef(this._el_11));
        this._text_12 = this.renderer.createText(null, '\n    ', null);
        this._el_13 = import85.createRenderElement(this.renderer, null, 'div', new import85.InlineArray2(2, 'class', 'map-div'), null);
    ...
    View_ApiDemoPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import103.Scroll) && ((11 <= requestNodeIndex) && (requestNodeIndex <= 14)))) {
            return this._Scroll_11_3.context;
        }
        if (((token === import101.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 15)))) {

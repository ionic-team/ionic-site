...
var View_ApiDemoPage_Host0 = (function (_super) {
    ...
    View_ApiDemoPage_Host0.prototype.createInternal = function (rootSelector) {
        ...
        this._ApiDemoPage_0_3 = new Wrapper_ApiDemoPage(this.injectorGet(import31.ActionSheetController, this.parentIndex), this.injectorGet(import67.Platform, this.parentIndex));
...
export var View_ApiDemoPage0 = (function (_super) {
    ...
    View_ApiDemoPage0.prototype.handleEvent_11 = function (eventName, $event) {
        ...
        var result = true;
        if ((eventName == 'click')) {
            var pd_sub_0 = (this.context.present() !== false);

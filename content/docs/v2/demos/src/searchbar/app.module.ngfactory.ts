...
export class View_ApiDemoPage0 extends import83.AppView<import1.ApiDemoPage> {
  ...
  _text_22:any;
  _anchor_23:any;
  /*private*/ _vc_23:import107.ViewContainer;
  ...
  createInternal(rootSelector:string):import89.ComponentRef<any> {
    ...
    this._el_10 = import85.createRenderElement(this.renderer,(null as any),'ion-searchbar',new import85.InlineArray2(2,'placeholder','Filter Items'),(null as any));
    this.compView_10 = new import103.View_Searchbar0(this.viewUtils,this,10,this._el_10);
    this._Searchbar_10_3 = new import103.Wrapper_Searchbar(this.parentView.injectorGet(import68.Config,this.parentIndex),new import94.ElementRef(this._el_10),this.renderer,this.parentView.injectorGet(import109.NgControl,this.parentIndex,(null as any)));
    ...
    this._Content_14_3 = new import105.Wrapper_Content(this.parentView.injectorGet(import68.Config,this.parentIndex),new import94.ElementRef(this._el_14),this.renderer,this.parentView.injectorGet(import12.App,this.parentIndex),this.parentView.injectorGet(import37.Keyboard,this.parentIndex),this.parentView.injectorGet(import59.NgZone,this.parentIndex),this.parentView.injectorGet(import92.ViewController,this.parentIndex,(null as any)),this.parentView.injectorGet(import110.Tabs,this.parentIndex,(null as any)),this.parentView.injectorGet(import10.DomController,this.parentIndex));
    this._text_15 = this.renderer.createText((null as any),'\n\n  ',(null as any));
    this._el_16 = import85.createRenderElement(this.renderer,(null as any),'ion-searchbar',new import85.InlineArray8(6,'color','danger','placeholder','Filter Items with Cancel','showCancelButton',''),(null as any));
    this.compView_16 = new import103.View_Searchbar0(this.viewUtils,this,16,this._el_16);
    this._Searchbar_16_3 = new import103.Wrapper_Searchbar(this.parentView.injectorGet(import68.Config,this.parentIndex),new import94.ElementRef(this._el_16),this.renderer,this.parentView.injectorGet(import109.NgControl,this.parentIndex,(null as any)));
    this.compView_16.create(this._Searchbar_16_3.context);
    this._text_17 = this.renderer.createText((null as any),'\n\n  ',(null as any));
    this._el_18 = import85.createRenderElement(this.renderer,(null as any),'p',new import85.InlineArray4(4,'padding-left','','padding-right',''),(null as any));
    ...
    this._el_21 = import85.createRenderElement(this.renderer,(null as any),'ion-list',import85.EMPTY_INLINE_ARRAY,(null as any));
    ...
    this._el_27 = import85.createRenderElement(this.renderer,parentRenderNode,'ion-footer',import85.EMPTY_INLINE_ARRAY,(null as any));
    this._Footer_27_3 = new import96.Wrapper_Footer(this.parentView.injectorGet(import68.Config,this.parentIndex),new import94.ElementRef(this._el_27),this.renderer,this.parentView.injectorGet(import92.ViewController,this.parentIndex,(null as any)));
    this._text_28 = this.renderer.createText(this._el_27,'\n\n  ',(null as any));
    this._el_29 = import85.createRenderElement(this.renderer,this._el_27,'ion-toolbar',new import85.InlineArray4(4,'class','toolbar','color','danger'),(null as any));
    this.compView_29 = new import96.View_Toolbar0(this.viewUtils,this,29,this._el_29);
    this._Toolbar_29_3 = new import96.Wrapper_Toolbar(this.parentView.injectorGet(import92.ViewController,this.parentIndex,(null as any)),this.parentView.injectorGet(import68.Config,this.parentIndex),new import94.ElementRef(this._el_29),this.renderer);
    this._text_30 = this.renderer.createText((null as any),'\n    ',(null as any));
    this._el_31 = import85.createRenderElement(this.renderer,(null as any),'ion-searchbar',new import85.InlineArray2(2,'placeholder','Search'),(null as any));
    this.compView_31 = new import103.View_Searchbar0(this.viewUtils,this,31,this._el_31);
    this._Searchbar_31_3 = new import103.Wrapper_Searchbar(this.parentView.injectorGet(import68.Config,this.parentIndex),new import94.ElementRef(this._el_31),this.renderer,this.parentView.injectorGet(import109.NgControl,this.parentIndex,(null as any)));
    ...
    var disposable_0:Function = import85.subscribeToRenderElement(this,this._el_10,new import85.InlineArray2(2,'ionInput',(null as any)),this.eventHandler(this.handleEvent_10));
    this._Searchbar_10_3.subscribe(this,this.eventHandler(this.handleEvent_10),true,false,false,false,false);
    var disposable_1:Function = import85.subscribeToRenderElement(this,this._el_16,new import85.InlineArray2(2,'ionInput',(null as any)),this.eventHandler(this.handleEvent_16));
    this._Searchbar_16_3.subscribe(this,this.eventHandler(this.handleEvent_16),true,false,false,false,false);
    var disposable_2:Function = import85.subscribeToRenderElement(this,this._el_31,new import85.InlineArray2(2,'ionInput',(null as any)),this.eventHandler(this.handleEvent_31));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import102.Searchbar) && (10 === requestNodeIndex))) { return this._Searchbar_10_3.context; }
    if (((token === import101.Toolbar) && ((8 <= requestNodeIndex) && (requestNodeIndex <= 11)))) { return this._Toolbar_8_3.context; }
    if (((token === import101.Header) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 12)))) { return this._Header_0_3.context; }
    if (((token === import102.Searchbar) && (16 === requestNodeIndex))) { return this._Searchbar_16_3.context; }
    if (((token === import111.TemplateRef) && (23 === requestNodeIndex))) { return this._TemplateRef_23_5; }
    if (((token === import112.NgFor) && (23 === requestNodeIndex))) { return this._NgFor_23_6.context; }
    if (((token === import113.List) && ((21 <= requestNodeIndex) && (requestNodeIndex <= 24)))) { return this._List_21_3.context; }
    if (((token === import104.Content) && ((14 <= requestNodeIndex) && (requestNodeIndex <= 25)))) { return this._Content_14_3.context; }
    if (((token === import102.Searchbar) && (31 === requestNodeIndex))) { return this._Searchbar_31_3.context; }
    if (((token === import101.Toolbar) && ((29 <= requestNodeIndex) && (requestNodeIndex <= 32)))) { return this._Toolbar_29_3.context; }
    if (((token === import101.Footer) && ((27 <= requestNodeIndex) && (requestNodeIndex <= 33)))) { return this._Footer_27_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
...
class View_ApiDemoPage1 extends import83.AppView<any> {
  _el_0:any;
  compView_0:import83.AppView<import114.Item>;
  _Item_0_3:import115.Wrapper_Item;
  _ItemContent_0_4:import115.Wrapper_ItemContent;
  _query_Label_0_0:import116.QueryList<any>;
  _query_Button_0_1:import116.QueryList<any>;
  _query_Icon_0_2:import116.QueryList<any>;
  _text_1:any;
  /*private*/ _expr_8:any;
  constructor(viewUtils:import85.ViewUtils,parentView:import83.AppView<any>,parentIndex:number,parentElement:any,declaredViewContainer:import107.ViewContainer) {
  ...
  createInternal(rootSelector:string):import89.ComponentRef<any> {
    ...
    this._Item_0_3 = new import115.Wrapper_Item(this.parentView.parentView.injectorGet(import34.Form,this.parentView.parentIndex),this.parentView.parentView.injectorGet(import68.Config,this.parentView.parentIndex),new import94.ElementRef(this._el_0),this.renderer,this.parentView.parentView.injectorGet(import117.ItemReorder,this.parentView.parentIndex,(null as any)));
    this._ItemContent_0_4 = new import115.Wrapper_ItemContent();
    this._query_Label_0_0 = new import116.QueryList<any>();
    this._query_Button_0_1 = new import116.QueryList<any>();
    this._query_Icon_0_2 = new import116.QueryList<any>();
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import114.Item) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) { return this._Item_0_3.context; }
    if (((token === import114.ItemContent) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) { return this._ItemContent_0_4.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_8:any = import85.inlineInterpolate(1,'\n      ',this.context.$implicit,'\n    ');

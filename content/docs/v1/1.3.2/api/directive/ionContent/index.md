...
&nbsp;
<a href='https://github.com/ionic-team/ionic-v1/edit/master/js/angular/directive/content.js#L1'>
Improve this doc
</a>
</div>
...
<br/>
<small>
Delegate: <a href="/docs/v1/api/service/$ionicScrollDelegate/"><code>$ionicScrollDelegate</code></a>
</small>
...
You can implement pull-to-refresh with the <a href="/docs/v1/api/directive/ionRefresher/"><code>ionRefresher</code></a>
directive, and infinite scrolling with the <a href="/docs/v1/api/directive/ionInfiniteScroll/"><code>ionInfiniteScroll</code></a>
directive.

If there is any dynamic content inside the ion-content, be sure to call `.resize()` with <a href="/docs/v1/api/service/$ionicScrollDelegate/"><code>$ionicScrollDelegate</code></a>
...
with <a href="/docs/v1/api/service/$ionicScrollDelegate/"><code>$ionicScrollDelegate</code></a>.</p>
...
Ionic scroll. See <a href="/docs/v1/api/provider/$ionicConfigProvider/"><code>$ionicConfigProvider</code></a> to set this as the global default.</p>

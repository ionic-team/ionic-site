...
&nbsp;
<a href='http://github.com/driftyco/ionic/edit/1.x/js/angular/directive/sideMenus.js#L3'>
Improve this doc
</a>
</div>
...
"Burger Icon" toggles can be added to the header with the <a href="/docs/nightly/api/directive/menuToggle/"><code>menuToggle</code></a>

...
var _View_ApiDemoPage0 = (function (_super) {
    ...
    _View_ApiDemoPage0.prototype.createInternal = function (rootSelector) {
        ...
        var compView_26 = import18.viewFactory_TextInput0(this.viewUtils, this.injector(26), this._appEl_26);
        ...
        this._appEl_26.initComponent(this._TextInput_26_4.context, [], compView_26);
        compView_26.create(this._TextInput_26_4.context, [], null);
        ...
        var compView_31 = import18.viewFactory_TextInput0(this.viewUtils, this.injector(31), this._appEl_31);
        ...
        this._appEl_31.initComponent(this._TextInput_31_4.context, [], compView_31);
        compView_31.create(this._TextInput_31_4.context, [], null);
        ...
        var compView_39 = import18.viewFactory_TextInput0(this.viewUtils, this.injector(39), this._appEl_39);
        ...
        this._appEl_39.initComponent(this._TextInput_39_4.context, [], compView_39);
        compView_39.create(this._TextInput_39_4.context, [], null);
        ...
        var compView_47 = import18.viewFactory_TextInput0(this.viewUtils, this.injector(47), this._appEl_47);
        ...
        this._appEl_47.initComponent(this._TextInput_47_4.context, [], compView_47);
        compView_47.create(this._TextInput_47_4.context, [], null);
        ...
        this._appEl_50 = new import3.AppElement(50, 11, this, this._el_50);
        var compView_50 = import15.viewFactory_Item0(this.viewUtils, this.injector(50), this._appEl_50);
        this._Item_50_4 = new import15.Wrapper_Item(this.parentInjector.get(import29.Form), this.parentInjector.get(import19.Config), new import20.ElementRef(this._el_50), this.renderer);
        this._ItemContent_50_5 = new import15.Wrapper_ItemContent();
        ...
        this._Label_52_3 = new import17.Wrapper_Label(this.parentInjector.get(import19.Config), new import20.ElementRef(this._el_52), this.renderer, '', null, null, null);
        ...
        var compView_55 = import18.viewFactory_TextInput0(this.viewUtils, this.injector(55), this._appEl_55);
        this._TextInput_55_4 = new import18.Wrapper_TextInput(this.parentInjector.get(import19.Config), this.parentInjector.get(import29.Form), this._Item_50_4.context, this.parentInjector.get(import22.App), this.parentInjector.get(import30.Platform), new import20.ElementRef(this._el_55), this.renderer, this._Content_9_4.context, this.parentInjector.get(import23.NavController, null), this.parentInjector.get(import31.NgControl, null));
        this._appEl_55.initComponent(this._TextInput_55_4.context, [], compView_55);
        compView_55.create(this._TextInput_55_4.context, [], null);
        ...
        this._Item_58_4 = new import15.Wrapper_Item(this.parentInjector.get(import29.Form), this.parentInjector.get(import19.Config), new import20.ElementRef(this._el_58), this.renderer);
        ...
        this._appEl_60 = new import3.AppElement(60, 58, this, this._el_60);
        var compView_60 = import18.viewFactory_TextInput0(this.viewUtils, this.injector(60), this._appEl_60);
        this._TextInput_60_4 = new import18.Wrapper_TextInput(this.parentInjector.get(import19.Config), this.parentInjector.get(import29.Form), this._Item_58_4.context, this.parentInjector.get(import22.App), this.parentInjector.get(import30.Platform), new import20.ElementRef(this._el_60), this.renderer, this._Content_9_4.context, this.parentInjector.get(import23.NavController, null), this.parentInjector.get(import31.NgControl, null));
        this._appEl_60.initComponent(this._TextInput_60_4.context, [], compView_60);
        compView_60.create(this._TextInput_60_4.context, [], null);
    ...
    _View_ApiDemoPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import35.TextInput) && (18 === requestNodeIndex))) {
            return this._TextInput_18_4.context;
        }
        ...
        if (((token === import35.TextInput) && (26 === requestNodeIndex))) {
            return this._TextInput_26_4.context;
        }
        ...
        if (((token === import35.TextInput) && (31 === requestNodeIndex))) {
            return this._TextInput_31_4.context;
        }
        ...
        if (((token === import35.TextInput) && (39 === requestNodeIndex))) {
            return this._TextInput_39_4.context;
        }
        ...
        if (((token === import35.TextInput) && (47 === requestNodeIndex))) {
            return this._TextInput_47_4.context;
        }
        ...
        if (((token === import34.Label) && ((52 <= requestNodeIndex) && (requestNodeIndex <= 53)))) {
            return this._Label_52_3.context;
        }
        if (((token === import35.TextInput) && (55 === requestNodeIndex))) {
            return this._TextInput_55_4.context;
        }
        ...
        if (((token === import35.TextInput) && (60 === requestNodeIndex))) {
            return this._TextInput_60_4.context;
        }
        if (((token === import36.Item) && ((58 <= requestNodeIndex) && (requestNodeIndex <= 61)))) {
            return this._Item_58_4.context;
        }
        if (((token === import36.ItemContent) && ((58 <= requestNodeIndex) && (requestNodeIndex <= 61)))) {
            return this._ItemContent_58_5.context;
        }
        if (((token === import37.List) && ((11 <= requestNodeIndex) && (requestNodeIndex <= 62)))) {
            return this._List_11_3.context;
        }
        if (((token === import38.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 63)))) {
    ...
    _View_ApiDemoPage0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        this._TextInput_18_4.check_placeholder(currVal_4, throwOnChange, false);
        this._TextInput_18_4.detectChangesInternal(this, this._el_18, throwOnChange);
        ...
        this._TextInput_26_4.check_placeholder(currVal_6, throwOnChange, false);
        var currVal_7 = 'tel';
        this._TextInput_26_4.check_type(currVal_7, throwOnChange, false);
        this._TextInput_26_4.detectChangesInternal(this, this._el_26, throwOnChange);
        ...
        this._TextInput_31_4.check_placeholder(currVal_8, throwOnChange, false);
        var currVal_9 = 'number';
        this._TextInput_31_4.check_type(currVal_9, throwOnChange, false);
        this._TextInput_31_4.detectChangesInternal(this, this._el_31, throwOnChange);
        ...
        this._Label_36_3.check_color(currVal_10, throwOnChange, false);
        this._Label_36_3.detectChangesInternal(this, this._el_36, throwOnChange);
        var currVal_11 = 'Email Input';
        this._TextInput_39_4.check_placeholder(currVal_11, throwOnChange, false);
        var currVal_12 = 'email';
        this._TextInput_39_4.check_type(currVal_12, throwOnChange, false);
        this._TextInput_39_4.detectChangesInternal(this, this._el_39, throwOnChange);
        ...
        this._Label_44_3.check_color(currVal_13, throwOnChange, false);
        this._Label_44_3.detectChangesInternal(this, this._el_44, throwOnChange);
        var currVal_14 = 'Password Input';
        this._TextInput_47_4.check_placeholder(currVal_14, throwOnChange, false);
        var currVal_15 = 'password';
        this._TextInput_47_4.check_type(currVal_15, throwOnChange, false);
        this._TextInput_47_4.detectChangesInternal(this, this._el_47, throwOnChange);
        ...
        this._Label_52_3.check_color(currVal_16, throwOnChange, false);
        this._Label_52_3.detectChangesInternal(this, this._el_52, throwOnChange);
        this._TextInput_55_4.detectChangesInternal(this, this._el_55, throwOnChange);
        ...
        this._TextInput_60_4.check_placeholder(currVal_17, throwOnChange, false);
        var currVal_18 = '';
        this._TextInput_60_4.check_clearInput(currVal_18, throwOnChange, false);
        this._TextInput_60_4.detectChangesInternal(this, this._el_60, throwOnChange);
        this.detectContentChildrenChanges(throwOnChange);
        if (!throwOnChange) {
            ...
            this._TextInput_18_4.context.ngAfterContentChecked();
            if ((this.numberOfChecks === 0)) {
                this._Item_13_4.context.ngAfterContentInit();
            }
            this._TextInput_26_4.context.ngAfterContentChecked();
            if ((this.numberOfChecks === 0)) {
                this._Item_21_4.context.ngAfterContentInit();
            }
            this._TextInput_31_4.context.ngAfterContentChecked();
            if ((this.numberOfChecks === 0)) {
                this._Item_29_4.context.ngAfterContentInit();
            }
            this._TextInput_39_4.context.ngAfterContentChecked();
            if ((this.numberOfChecks === 0)) {
                this._Item_34_4.context.ngAfterContentInit();
            }
            this._TextInput_47_4.context.ngAfterContentChecked();
            if ((this.numberOfChecks === 0)) {
                this._Item_42_4.context.ngAfterContentInit();
            }
            this._TextInput_55_4.context.ngAfterContentChecked();
            if ((this.numberOfChecks === 0)) {
                this._Item_50_4.context.ngAfterContentInit();
            }
            this._TextInput_60_4.context.ngAfterContentChecked();
            if ((this.numberOfChecks === 0)) {
    ...
    _View_ApiDemoPage0.prototype.destroyInternal = function () {
        this._TextInput_18_4.context.ngOnDestroy();
        this._TextInput_26_4.context.ngOnDestroy();
        this._TextInput_31_4.context.ngOnDestroy();
        this._TextInput_39_4.context.ngOnDestroy();
        this._TextInput_47_4.context.ngOnDestroy();
        this._TextInput_55_4.context.ngOnDestroy();
        this._TextInput_60_4.context.ngOnDestroy();

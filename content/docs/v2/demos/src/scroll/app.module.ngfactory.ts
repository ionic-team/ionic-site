...
export class View_ApiDemoPage0 extends import82.AppView<import1.ApiDemoPage> {
  ...
  createInternal(rootSelector:string):import88.ComponentRef<any> {
    ...
    this._el_11 = import84.createRenderElement(this.renderer,(null as any),'ion-scroll',new import84.InlineArray8(6,'scrollX','true','scrollY','true','style','width: 100%; height: 100%'),(null as any));
    ...
    this._el_13 = import84.createRenderElement(this.renderer,(null as any),'div',new import84.InlineArray2(2,'class','map-div'),(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import102.Scroll) && ((11 <= requestNodeIndex) && (requestNodeIndex <= 14)))) { return this._Scroll_11_3.context; }
    if (((token === import100.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 15)))) { return this._Content_9_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_11_0_1:any = 'true';
    this._Scroll_11_3.check_scrollY(currVal_11_0_1,throwOnChange,false);
    if (this._Scroll_11_3.ngDoCheck(this,this._el_11,throwOnChange)) { this.compView_11.markAsCheckOnce(); }

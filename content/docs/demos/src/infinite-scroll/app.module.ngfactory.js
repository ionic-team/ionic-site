...
import * as import113 from '../components/infinite-scroll/infinite-scroll';
...
var AppModuleInjector = (function (_super) {
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_MockProvider_75", {
        get: function () {
            if ((this.__MockProvider_75 == null)) {
                (this.__MockProvider_75 = new import1.MockProvider());
            }
            return this.__MockProvider_75;
        },
        enumerable: true,
        configurable: true
    });
...
export var View_ApiDemoPage0 = (function (_super) {
    ...
    View_ApiDemoPage0.prototype.createInternal = function (rootSelector) {
        ...
        this._vc_13 = new import103.ViewContainer(13, 11, this, this._anchor_13);
        this._TemplateRef_13_5 = new import110.TemplateRef_(this, 13, this._anchor_13);
        this._NgFor_13_6 = new import104.Wrapper_NgFor(this._vc_13.vcRef, this._TemplateRef_13_5, this.parentView.injectorGet(import77.IterableDiffers, this.parentIndex), this.ref);
        this._text_14 = this.renderer.createText(this._el_11, '\n  ', null);
        this._text_15 = this.renderer.createText(null, '\n\n  ', null);
        this._el_16 = import84.createRenderElement(this.renderer, null, 'ion-infinite-scroll', new import84.InlineArray2(2, 'threshold', '100px'), null);
        this._InfiniteScroll_16_3 = new import105.Wrapper_InfiniteScroll(this._Content_9_3.context, this.parentView.injectorGet(import58.NgZone, this.parentIndex), new import93.ElementRef(this._el_16), this.parentView.injectorGet(import10.DomController, this.parentIndex));
        this._text_17 = this.renderer.createText(this._el_16, '\n    ', null);
        this._el_18 = import84.createRenderElement(this.renderer, this._el_16, 'ion-infinite-scroll-content', new import84.InlineArray4(4, 'loadingSpinner', 'bubbles', 'loadingText', 'Loading more data...'), null);
        this.compView_18 = new import107.View_InfiniteScrollContent0(this.viewUtils, this, 18, this._el_18);
        this._InfiniteScrollContent_18_3 = new import107.Wrapper_InfiniteScrollContent(this._InfiniteScroll_16_3.context, this.parentView.injectorGet(import67.Config, this.parentIndex));
        ...
        var disposable_0 = import84.subscribeToRenderElement(this, this._el_16, new import84.InlineArray2(2, 'ionInfinite', null), this.eventHandler(this.handleEvent_16));
    ...
    View_ApiDemoPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import110.TemplateRef) && (13 === requestNodeIndex))) {
            return this._TemplateRef_13_5;
        }
        if (((token === import111.NgFor) && (13 === requestNodeIndex))) {
            return this._NgFor_13_6.context;
        }
        if (((token === import112.List) && ((11 <= requestNodeIndex) && (requestNodeIndex <= 14)))) {
            return this._List_11_3.context;
        }
        if (((token === import106.InfiniteScrollContent) && ((18 <= requestNodeIndex) && (requestNodeIndex <= 19)))) {
            return this._InfiniteScrollContent_18_3.context;
        }
        if (((token === import113.InfiniteScroll) && ((16 <= requestNodeIndex) && (requestNodeIndex <= 20)))) {

...
Delegate for controlling the <a href="/docs/nightly/api/directive/ionList/"><code>ionList</code></a> directive.

Methods called directly on the $ionicListDelegate service will control all lists.
Use the <a href="/docs/nightly/api/service/$ionicListDelegate/#$getByHandle">$getByHandle</a>
...
<a href="/docs/nightly/api/directive/ionList/"><code>ionList</code></a> directives with `delegate-handle` matching
the given handle.

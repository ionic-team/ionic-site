...
<a class="improve-v2-docs" href="http://github.com/driftyco/ionic-native/edit/master/src/plugins/photo-library.ts#L1">
  Improve this doc
</a>
...
<pre><code>$ ionic plugin add cordova-plugin-photo-library --variable PHOTO_LIBRARY_USAGE_DESCRIPTION="To choose photos"</code></pre>
<p>Repo:
...
<pre><code>import { PhotoLibrary } from &#39;ionic-native&#39;;
...
<h3><code>getLibrary(options)</code>
...
<h3><code>requestAuthorization(options)</code>
...
<div id="getAlbums"></div>
<h3><code>getAlbums()</code>
...
<div id="getThumbnailURL"></div>
<h3><code>getThumbnailURL(photo,&nbsp;options)</code>
...
<div id="getPhotoURL"></div>
<h3><code>getPhotoURL(photo,&nbsp;options)</code>
...
<h3><code>getThumbnail(photo,&nbsp;options)</code>
...
<div id="getPhoto"></div>
<h3><code>getPhoto(photo,&nbsp;options)</code>
...
<h3><code>saveImage(url,&nbsp;album,&nbsp;options)</code>
...
<div id="saveVideo"></div>
<h3><code>saveVideo(url,&nbsp;album)</code>

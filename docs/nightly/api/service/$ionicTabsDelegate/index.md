...
<div class="improve-docs">
  <a href='http://github.com/driftyco/ionic/tree/master/js/angular/service/tabsDelegate.js#L1'>
    View Source
  </a>
  &nbsp;
...
Delegate for controlling the <a href="/docs/nightly/api/directive/ionTabs/"><code>ionTabs</code></a> directive.

Methods called directly on the $ionicTabsDelegate service will control all ionTabs
directives. Use the <a href="/docs/nightly/api/service/$ionicTabsDelegate/#$getByHandle">$getByHandle</a>
...
<a href="/docs/nightly/api/directive/ionTabs/"><code>ionTabs</code></a> directives with `delegate-handle` matching
the given handle.

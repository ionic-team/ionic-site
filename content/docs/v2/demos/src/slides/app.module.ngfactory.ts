...
export class View_ApiDemoPage0 extends import82.AppView<import1.ApiDemoPage> {
  ...
  _text_1:any;
  _anchor_2:any;
  /*private*/ _vc_2:import97.ViewContainer;
  ...
  constructor(viewUtils:import84.ViewUtils,parentView:import82.AppView<any>,parentIndex:number,parentElement:any) {
    ...
    this._arr_10 = import84.pureProxy5((p0:any,p1:any,p2:any,p3:any,p4:any):any[] => {
      return [
        p0,
        p1,
        p2,
  ...
  createInternal(rootSelector:string):import88.ComponentRef<any> {
    const parentRenderNode:any = this.renderer.createViewRoot(this.parentElement);
    this._el_0 = import84.createRenderElement(this.renderer,parentRenderNode,'ion-slides',new import84.InlineArray4(4,'loop','true','style','background-color: black'),(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import99.TemplateRef) && (2 === requestNodeIndex))) { return this._TemplateRef_2_5; }
    if (((token === import100.NgFor) && (2 === requestNodeIndex))) { return this._NgFor_2_6.context; }
    if (((token === import95.Slides) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 3)))) { return this._Slides_0_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
...
class View_ApiDemoPage1 extends import82.AppView<any> {
  _el_0:any;
  compView_0:import82.AppView<import95.Slide>;
  _Slide_0_3:import96.Wrapper_Slide;
  _text_1:any;
  _el_2:any;
  _text_3:any;
  /*private*/ _expr_6:any;
  constructor(viewUtils:import84.ViewUtils,parentView:import82.AppView<any>,parentIndex:number,parentElement:any,declaredViewContainer:import97.ViewContainer) {
  ...
  createInternal(rootSelector:string):import88.ComponentRef<any> {
    this._el_0 = import84.createRenderElement(this.renderer,(null as any),'ion-slide',import84.EMPTY_INLINE_ARRAY,(null as any));
    this.compView_0 = new import96.View_Slide0(this.viewUtils,this,0,this._el_0);
    this._Slide_0_3 = new import96.Wrapper_Slide(new import93.ElementRef(this._el_0),(<View_ApiDemoPage0>this.parentView)._Slides_0_3.context);
    this._text_1 = this.renderer.createText((null as any),'\n    ',(null as any));
    this._el_2 = import84.createRenderElement(this.renderer,(null as any),'img',import84.EMPTY_INLINE_ARRAY,(null as any));
    this._text_3 = this.renderer.createText((null as any),'\n  ',(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import95.Slide) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 3)))) { return this._Slide_0_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    if (this._Slide_0_3.ngDoCheck(this,this._el_0,throwOnChange)) { this.compView_0.markAsCheckOnce(); }
    const currVal_6:any = import84.inlineInterpolate(1,'./slide',this.context.$implicit,'.jpeg');

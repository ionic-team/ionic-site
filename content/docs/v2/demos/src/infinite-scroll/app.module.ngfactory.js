...
import * as import114 from '../components/infinite-scroll/infinite-scroll';
import * as import115 from '../components/item/item';
import * as import116 from '../components/item/item.ngfactory';
import * as import117 from '@angular/core/src/linker/query_list';
...
var AppModuleInjector = (function (_super) {
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_MockProvider_76", {
        get: function () {
            if ((this.__MockProvider_76 == null)) {
                (this.__MockProvider_76 = new import1.MockProvider());
            }
            return this.__MockProvider_76;
        },
        enumerable: true,
        configurable: true
    });
    ...
    AppModuleInjector.prototype.getInternal = function (token, notFoundResult) {
        ...
        if ((token === import1.MockProvider)) {
            return this._MockProvider_76;
        }
...
export var View_ApiDemoApp0 = (function (_super) {
    ...
    View_ApiDemoApp0.prototype.detectChangesInternal = function (throwOnChange) {
        var currVal_0_0_0 = this.context.rootPage;
...
var View_ApiDemoPage_Host0 = (function (_super) {
    ...
    View_ApiDemoPage_Host0.prototype.createInternal = function (rootSelector) {
        ...
        this._ApiDemoPage_0_3 = new Wrapper_ApiDemoPage(this.injectorGet(import1.MockProvider, this.parentIndex));
...
export var View_ApiDemoPage0 = (function (_super) {
    ...
    View_ApiDemoPage0.prototype.createInternal = function (rootSelector) {
        ...
        this._ToolbarTitle_4_3 = new import100.Wrapper_ToolbarTitle(this.parentView.injectorGet(import68.Config, this.parentIndex), new import94.ElementRef(this._el_4), this.renderer, this.parentView.injectorGet(import109.Toolbar, this.parentIndex, null), this._Navbar_2_3.context);
        ...
        this._vc_13 = new import104.ViewContainer(13, 11, this, this._anchor_13);
        this._TemplateRef_13_5 = new import111.TemplateRef_(this, 13, this._anchor_13);
        this._NgFor_13_6 = new import105.Wrapper_NgFor(this._vc_13.vcRef, this._TemplateRef_13_5, this.parentView.injectorGet(import78.IterableDiffers, this.parentIndex), this.ref);
        this._text_14 = this.renderer.createText(this._el_11, '\n  ', null);
        this._text_15 = this.renderer.createText(null, '\n\n  ', null);
        this._el_16 = import85.createRenderElement(this.renderer, null, 'ion-infinite-scroll', new import85.InlineArray2(2, 'threshold', '100px'), null);
        this._InfiniteScroll_16_3 = new import106.Wrapper_InfiniteScroll(this._Content_9_3.context, this.parentView.injectorGet(import59.NgZone, this.parentIndex), new import94.ElementRef(this._el_16), this.parentView.injectorGet(import10.DomController, this.parentIndex));
        this._text_17 = this.renderer.createText(this._el_16, '\n    ', null);
        this._el_18 = import85.createRenderElement(this.renderer, this._el_16, 'ion-infinite-scroll-content', new import85.InlineArray4(4, 'loadingSpinner', 'bubbles', 'loadingText', 'Loading more data...'), null);
        this.compView_18 = new import108.View_InfiniteScrollContent0(this.viewUtils, this, 18, this._el_18);
        this._InfiniteScrollContent_18_3 = new import108.Wrapper_InfiniteScrollContent(this._InfiniteScroll_16_3.context, this.parentView.injectorGet(import68.Config, this.parentIndex));
        this._text_19 = this.renderer.createText(null, '\n    ', null);
        this.compView_18.create(this._InfiniteScrollContent_18_3.context);
        ...
        var disposable_0 = import85.subscribeToRenderElement(this, this._el_16, new import85.InlineArray2(2, 'ionInfinite', null), this.eventHandler(this.handleEvent_16));
        this._InfiniteScroll_16_3.subscribe(this, this.eventHandler(this.handleEvent_16), true);
    ...
    View_ApiDemoPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import111.TemplateRef) && (13 === requestNodeIndex))) {
            return this._TemplateRef_13_5;
        }
        if (((token === import112.NgFor) && (13 === requestNodeIndex))) {
            return this._NgFor_13_6.context;
        }
        if (((token === import113.List) && ((11 <= requestNodeIndex) && (requestNodeIndex <= 14)))) {
            return this._List_11_3.context;
        }
        if (((token === import107.InfiniteScrollContent) && ((18 <= requestNodeIndex) && (requestNodeIndex <= 19)))) {
            return this._InfiniteScrollContent_18_3.context;
        }
        if (((token === import114.InfiniteScroll) && ((16 <= requestNodeIndex) && (requestNodeIndex <= 20)))) {
            return this._InfiniteScroll_16_3.context;
        }
        if (((token === import101.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 21)))) {
    ...
    View_ApiDemoPage0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        var currVal_13_0_0 = this.context.items;
        ...
        var currVal_16_0_0 = '100px';
        this._InfiniteScroll_16_3.check_threshold(currVal_16_0_0, throwOnChange, false);
        this._InfiniteScroll_16_3.ngDoCheck(this, this._el_16, throwOnChange);
        var currVal_18_0_0 = 'bubbles';
        this._InfiniteScrollContent_18_3.check_loadingSpinner(currVal_18_0_0, throwOnChange, false);
        var currVal_18_0_1 = 'Loading more data...';
        this._InfiniteScrollContent_18_3.check_loadingText(currVal_18_0_1, throwOnChange, false);
        this._InfiniteScrollContent_18_3.ngDoCheck(this, this._el_18, throwOnChange);
        ...
        this._InfiniteScrollContent_18_3.checkHost(this, this.compView_18, this._el_18, throwOnChange);
    ...
    View_ApiDemoPage0.prototype.createEmbeddedViewInternal = function (nodeIndex) {
        if ((nodeIndex == 13)) {
            return new View_ApiDemoPage1(this.viewUtils, this, 13, this._anchor_13, this._vc_13);
        }
        return null;
    };
    View_ApiDemoPage0.prototype.handleEvent_16 = function (eventName, $event) {
        ...
        var result = true;
        if ((eventName == 'ionInfinite')) {
            var pd_sub_0 = (this.context.doInfinite($event) !== false);
...
var View_ApiDemoPage1 = (function (_super) {
    ...
    View_ApiDemoPage1.prototype.createInternal = function (rootSelector) {
        ...
        this.compView_0 = new import116.View_Item0(this.viewUtils, this, 0, this._el_0);
        this._Item_0_3 = new import116.Wrapper_Item(this.parentView.parentView.injectorGet(import34.Form, this.parentView.parentIndex), this.parentView.parentView.injectorGet(import68.Config, this.parentView.parentIndex), new import94.ElementRef(this._el_0), this.renderer, this.parentView.parentView.injectorGet(import118.ItemReorder, this.parentView.parentIndex, null));
        this._ItemContent_0_4 = new import116.Wrapper_ItemContent();
        this._query_Label_0_0 = new import117.QueryList();
        this._query_Button_0_1 = new import117.QueryList();
        this._query_Icon_0_2 = new import117.QueryList();
    ...
    View_ApiDemoPage1.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import115.Item) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) {
            return this._Item_0_3.context;
        }
        if (((token === import115.ItemContent) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) {

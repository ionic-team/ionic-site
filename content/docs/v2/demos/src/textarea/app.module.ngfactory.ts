...
export class View_ApiDemoPage0 extends import83.AppView<import1.ApiDemoPage> {
  ...
  createInternal(rootSelector:string):import89.ComponentRef<any> {
    ...
    this._el_18 = import85.createRenderElement(this.renderer,(null as any),'ion-textarea',new import85.InlineArray2(2,'placeholder','Textarea'),(null as any));
    ...
    this._el_26 = import85.createRenderElement(this.renderer,(null as any),'ion-textarea',new import85.InlineArray2(2,'placeholder','Textarea'),(null as any));
    this.compView_26 = new import109.View_TextArea0(this.viewUtils,this,26,this._el_26);
    this._TextArea_26_3 = new import109.Wrapper_TextArea(this.parentView.injectorGet(import68.Config,this.parentIndex),this.parentView.injectorGet(import34.Form,this.parentIndex),this._Item_21_3.context,this.parentView.injectorGet(import12.App,this.parentIndex),this.parentView.injectorGet(import67.Platform,this.parentIndex),new import94.ElementRef(this._el_26),this.renderer,this._Content_9_3.context,this.parentView.injectorGet(import93.NavController,this.parentIndex,(null as any)),this.parentView.injectorGet(import113.NgControl,this.parentIndex,(null as any)),this.parentView.injectorGet(import10.DomController,this.parentIndex));
    ...
    this._el_31 = import85.createRenderElement(this.renderer,(null as any),'ion-textarea',new import85.InlineArray2(2,'placeholder','Textarea with no label'),(null as any));
    this.compView_31 = new import109.View_TextArea0(this.viewUtils,this,31,this._el_31);
    this._TextArea_31_3 = new import109.Wrapper_TextArea(this.parentView.injectorGet(import68.Config,this.parentIndex),this.parentView.injectorGet(import34.Form,this.parentIndex),this._Item_29_3.context,this.parentView.injectorGet(import12.App,this.parentIndex),this.parentView.injectorGet(import67.Platform,this.parentIndex),new import94.ElementRef(this._el_31),this.renderer,this._Content_9_3.context,this.parentView.injectorGet(import93.NavController,this.parentIndex,(null as any)),this.parentView.injectorGet(import113.NgControl,this.parentIndex,(null as any)),this.parentView.injectorGet(import10.DomController,this.parentIndex));
    ...
    this._el_39 = import85.createRenderElement(this.renderer,(null as any),'ion-textarea',new import85.InlineArray2(2,'placeholder','Textarea'),(null as any));
    this.compView_39 = new import109.View_TextArea0(this.viewUtils,this,39,this._el_39);
    this._TextArea_39_3 = new import109.Wrapper_TextArea(this.parentView.injectorGet(import68.Config,this.parentIndex),this.parentView.injectorGet(import34.Form,this.parentIndex),this._Item_34_3.context,this.parentView.injectorGet(import12.App,this.parentIndex),this.parentView.injectorGet(import67.Platform,this.parentIndex),new import94.ElementRef(this._el_39),this.renderer,this._Content_9_3.context,this.parentView.injectorGet(import93.NavController,this.parentIndex,(null as any)),this.parentView.injectorGet(import113.NgControl,this.parentIndex,(null as any)),this.parentView.injectorGet(import10.DomController,this.parentIndex));
    ...
    this._el_44 = import85.createRenderElement(this.renderer,(null as any),'ion-label',new import85.InlineArray4(4,'color','primary','floating',''),(null as any));
    ...
    this._el_47 = import85.createRenderElement(this.renderer,(null as any),'ion-textarea',import85.EMPTY_INLINE_ARRAY,(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import108.TextArea) && (18 === requestNodeIndex))) { return this._TextArea_18_3.context; }
    ...
    if (((token === import108.TextArea) && (26 === requestNodeIndex))) { return this._TextArea_26_3.context; }
    ...
    if (((token === import108.TextArea) && (31 === requestNodeIndex))) { return this._TextArea_31_3.context; }
    ...
    if (((token === import108.TextArea) && (39 === requestNodeIndex))) { return this._TextArea_39_3.context; }
    ...
    if (((token === import108.TextArea) && (47 === requestNodeIndex))) { return this._TextArea_47_3.context; }
    ...
    if (((token === import115.List) && ((11 <= requestNodeIndex) && (requestNodeIndex <= 49)))) { return this._List_11_3.context; }
    if (((token === import101.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 50)))) { return this._Content_9_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {

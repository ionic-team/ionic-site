...
<a href="/docs/v1/nightly/api/directive/ionContent/"><code>ionContent</code></a> and
<a href="/docs/v1/nightly/api/directive/ionScroll/"><code>ionScroll</code></a> directives).

Methods called directly on the $ionicScrollDelegate service will control all scroll
views.  Use the <a href="/docs/v1/nightly/api/service/$ionicScrollDelegate/#$getByHandle">$getByHandle</a>

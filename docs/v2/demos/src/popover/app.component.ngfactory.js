...
var _View_PopoverRadioPage_Host0 = (function (_super) {
    ...
    _View_PopoverRadioPage_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import3.PopoverRadioPage) && (0 === requestNodeIndex))) {
...
export var PopoverRadioPageNgFactory = new import10.ComponentFactory('ng-component', viewFactory_PopoverRadioPage_Host0, import3.PopoverRadioPage);
...
var _View_PopoverRadioPage0 = (function (_super) {
    ...
    _View_PopoverRadioPage0.prototype.createInternal = function (rootSelector) {
        ...
        this._NgModel_1_5 = new import12.NgModel(null, null, null, this._NG_VALUE_ACCESSOR_1_4);
        ...
        var compView_7 = import24.viewFactory_Item0(this.viewUtils, this.injector(7), this._appEl_7);
        ...
        var compView_13 = import24.viewFactory_Item0(this.viewUtils, this.injector(13), this._appEl_13);
        ...
        this._Button_22_4 = new import18.Button(null, 'dot', this.parentInjector.get(import22.Config), new import21.ElementRef(this._el_22), this.renderer);
        this._appEl_22.initComponent(this._Button_22_4, [], compView_22);
        compView_22.create(this._Button_22_4, [[]], null);
        ...
        var compView_27 = import26.viewFactory_Button0(this.viewUtils, this.injector(27), this._appEl_27);
        this._Button_27_4 = new import18.Button(null, 'dot', this.parentInjector.get(import22.Config), new import21.ElementRef(this._el_27), this.renderer);
        this._appEl_27.initComponent(this._Button_27_4, [], compView_27);
        compView_27.create(this._Button_27_4, [[]], null);
        ...
        var compView_32 = import26.viewFactory_Button0(this.viewUtils, this.injector(32), this._appEl_32);
        this._Button_32_4 = new import18.Button(null, 'dot', this.parentInjector.get(import22.Config), new import21.ElementRef(this._el_32), this.renderer);
        this._appEl_32.initComponent(this._Button_32_4, [], compView_32);
        compView_32.create(this._Button_32_4, [[]], null);
        ...
        this._Button_37_4 = new import18.Button(null, 'dot', this.parentInjector.get(import22.Config), new import21.ElementRef(this._el_37), this.renderer);
        this._appEl_37.initComponent(this._Button_37_4, [], compView_37);
        compView_37.create(this._Button_37_4, [[]], null);
        ...
        var compView_41 = import24.viewFactory_Item0(this.viewUtils, this.injector(41), this._appEl_41);
        ...
        this._Label_43_3 = new import19.Label(this.parentInjector.get(import22.Config), new import21.ElementRef(this._el_43), this.renderer, null, null, null, null);
        ...
        var compView_46 = import27.viewFactory_RadioButton0(this.viewUtils, this.injector(46), this._appEl_46);
        ...
        compView_46.create(this._RadioButton_46_4, [], null);
        ...
        this._Label_51_3 = new import19.Label(this.parentInjector.get(import22.Config), new import21.ElementRef(this._el_51), this.renderer, null, null, null, null);
        ...
        var compView_54 = import27.viewFactory_RadioButton0(this.viewUtils, this.injector(54), this._appEl_54);
        ...
        compView_54.create(this._RadioButton_54_4, [], null);
        ...
        var compView_57 = import24.viewFactory_Item0(this.viewUtils, this.injector(57), this._appEl_57);
        ...
        this._Label_59_3 = new import19.Label(this.parentInjector.get(import22.Config), new import21.ElementRef(this._el_59), this.renderer, null, null, null, null);
        ...
        var compView_62 = import27.viewFactory_RadioButton0(this.viewUtils, this.injector(62), this._appEl_62);
        ...
        compView_62.create(this._RadioButton_62_4, [], null);
        ...
        var compView_65 = import24.viewFactory_Item0(this.viewUtils, this.injector(65), this._appEl_65);
        ...
        this._Label_67_3 = new import19.Label(this.parentInjector.get(import22.Config), new import21.ElementRef(this._el_67), this.renderer, null, null, null, null);
        ...
        var compView_70 = import27.viewFactory_RadioButton0(this.viewUtils, this.injector(70), this._appEl_70);
        ...
        compView_70.create(this._RadioButton_70_4, [], null);
        ...
        var compView_73 = import24.viewFactory_Item0(this.viewUtils, this.injector(73), this._appEl_73);
        ...
        this._Label_75_3 = new import19.Label(this.parentInjector.get(import22.Config), new import21.ElementRef(this._el_75), this.renderer, null, null, null, null);
        ...
        var compView_78 = import27.viewFactory_RadioButton0(this.viewUtils, this.injector(78), this._appEl_78);
        ...
        this._Label_83_3 = new import19.Label(this.parentInjector.get(import22.Config), new import21.ElementRef(this._el_83), this.renderer, null, null, null, null);
        ...
        var compView_86 = import27.viewFactory_RadioButton0(this.viewUtils, this.injector(86), this._appEl_86);
        ...
        var compView_89 = import24.viewFactory_Item0(this.viewUtils, this.injector(89), this._appEl_89);
        ...
        this._Label_91_3 = new import19.Label(this.parentInjector.get(import22.Config), new import21.ElementRef(this._el_91), this.renderer, null, null, null, null);
        ...
        var compView_94 = import27.viewFactory_RadioButton0(this.viewUtils, this.injector(94), this._appEl_94);
        ...
        var subscription_0 = this._RadioGroup_1_3.ionChange.subscribe(this.eventHandler(this._handle_ionChange_1_1.bind(this)));
        this._expr_2 = import7.UNINITIALIZED;
        var subscription_1 = this._NgModel_1_5.update.subscribe(this.eventHandler(this._handle_ngModelChange_1_0.bind(this)));
    ...
    _View_PopoverRadioPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import17.Item) && ((7 <= requestNodeIndex) && (requestNodeIndex <= 8)))) {
            return this._Item_7_4;
        }
        if (((token === import17.ItemContent) && ((7 <= requestNodeIndex) && (requestNodeIndex <= 8)))) {
            return this._ItemContent_7_5;
        }
        if (((token === import16.Col) && ((5 <= requestNodeIndex) && (requestNodeIndex <= 9)))) {
            return this._Col_5_3;
        }
        if (((token === import17.Item) && ((13 <= requestNodeIndex) && (requestNodeIndex <= 14)))) {
            return this._Item_13_4;
        }
        if (((token === import17.ItemContent) && ((13 <= requestNodeIndex) && (requestNodeIndex <= 14)))) {
            return this._ItemContent_13_5;
        }
        if (((token === import16.Col) && ((11 <= requestNodeIndex) && (requestNodeIndex <= 15)))) {
            return this._Col_11_3;
        }
        if (((token === import16.Row) && ((3 <= requestNodeIndex) && (requestNodeIndex <= 16)))) {
            return this._Row_3_3;
        }
        if (((token === import18.Button) && (22 === requestNodeIndex))) {
            return this._Button_22_4;
        }
        if (((token === import16.Col) && ((20 <= requestNodeIndex) && (requestNodeIndex <= 23)))) {
            return this._Col_20_3;
        }
        if (((token === import18.Button) && (27 === requestNodeIndex))) {
            return this._Button_27_4;
        }
        if (((token === import16.Col) && ((25 <= requestNodeIndex) && (requestNodeIndex <= 28)))) {
            return this._Col_25_3;
        }
        if (((token === import18.Button) && (32 === requestNodeIndex))) {
            return this._Button_32_4;
        }
        if (((token === import16.Col) && ((30 <= requestNodeIndex) && (requestNodeIndex <= 33)))) {
            return this._Col_30_3;
        }
        if (((token === import18.Button) && (37 === requestNodeIndex))) {
            return this._Button_37_4;
        }
        if (((token === import16.Col) && ((35 <= requestNodeIndex) && (requestNodeIndex <= 38)))) {
            return this._Col_35_3;
        }
        if (((token === import16.Row) && ((18 <= requestNodeIndex) && (requestNodeIndex <= 39)))) {
            return this._Row_18_3;
        }
        if (((token === import19.Label) && ((43 <= requestNodeIndex) && (requestNodeIndex <= 44)))) {
            return this._Label_43_3;
        }
        if (((token === import20.RadioButton) && (46 === requestNodeIndex))) {
            return this._RadioButton_46_4;
        }
        if (((token === import17.Item) && ((41 <= requestNodeIndex) && (requestNodeIndex <= 47)))) {
            return this._Item_41_4;
        }
        if (((token === import17.ItemContent) && ((41 <= requestNodeIndex) && (requestNodeIndex <= 47)))) {
            return this._ItemContent_41_5;
        }
        if (((token === import19.Label) && ((51 <= requestNodeIndex) && (requestNodeIndex <= 52)))) {
            return this._Label_51_3;
        }
        if (((token === import20.RadioButton) && (54 === requestNodeIndex))) {
            return this._RadioButton_54_4;
        }
        if (((token === import17.Item) && ((49 <= requestNodeIndex) && (requestNodeIndex <= 55)))) {
            return this._Item_49_4;
        }
        if (((token === import17.ItemContent) && ((49 <= requestNodeIndex) && (requestNodeIndex <= 55)))) {
            return this._ItemContent_49_5;
        }
        if (((token === import19.Label) && ((59 <= requestNodeIndex) && (requestNodeIndex <= 60)))) {
            return this._Label_59_3;
        }
        if (((token === import20.RadioButton) && (62 === requestNodeIndex))) {
            return this._RadioButton_62_4;
        }
        if (((token === import17.Item) && ((57 <= requestNodeIndex) && (requestNodeIndex <= 63)))) {
            return this._Item_57_4;
        }
        if (((token === import17.ItemContent) && ((57 <= requestNodeIndex) && (requestNodeIndex <= 63)))) {
            return this._ItemContent_57_5;
        }
        if (((token === import19.Label) && ((67 <= requestNodeIndex) && (requestNodeIndex <= 68)))) {
            return this._Label_67_3;
        }
        if (((token === import20.RadioButton) && (70 === requestNodeIndex))) {
            return this._RadioButton_70_4;
        }
        if (((token === import17.Item) && ((65 <= requestNodeIndex) && (requestNodeIndex <= 71)))) {
            return this._Item_65_4;
        }
        if (((token === import17.ItemContent) && ((65 <= requestNodeIndex) && (requestNodeIndex <= 71)))) {
            return this._ItemContent_65_5;
        }
        if (((token === import19.Label) && ((75 <= requestNodeIndex) && (requestNodeIndex <= 76)))) {
            return this._Label_75_3;
        }
        if (((token === import20.RadioButton) && (78 === requestNodeIndex))) {
            return this._RadioButton_78_4;
        }
        if (((token === import17.Item) && ((73 <= requestNodeIndex) && (requestNodeIndex <= 79)))) {
            return this._Item_73_4;
        }
        if (((token === import17.ItemContent) && ((73 <= requestNodeIndex) && (requestNodeIndex <= 79)))) {
            return this._ItemContent_73_5;
        }
        if (((token === import19.Label) && ((83 <= requestNodeIndex) && (requestNodeIndex <= 84)))) {
            return this._Label_83_3;
        }
        if (((token === import20.RadioButton) && (86 === requestNodeIndex))) {
            return this._RadioButton_86_4;
        }
        if (((token === import17.Item) && ((81 <= requestNodeIndex) && (requestNodeIndex <= 87)))) {
            return this._Item_81_4;
        }
        if (((token === import17.ItemContent) && ((81 <= requestNodeIndex) && (requestNodeIndex <= 87)))) {
            return this._ItemContent_81_5;
        }
        if (((token === import19.Label) && ((91 <= requestNodeIndex) && (requestNodeIndex <= 92)))) {
            return this._Label_91_3;
        }
        if (((token === import20.RadioButton) && (94 === requestNodeIndex))) {
            return this._RadioButton_94_4;
        }
        if (((token === import17.Item) && ((89 <= requestNodeIndex) && (requestNodeIndex <= 95)))) {
            return this._Item_89_4;
        }
        if (((token === import17.ItemContent) && ((89 <= requestNodeIndex) && (requestNodeIndex <= 95)))) {
            return this._ItemContent_89_5;
        }
        if (((token === import11.RadioGroup) && ((1 <= requestNodeIndex) && (requestNodeIndex <= 96)))) {
            return this._RadioGroup_1_3;
        }
        if (((token === import28.NG_VALUE_ACCESSOR) && ((1 <= requestNodeIndex) && (requestNodeIndex <= 96)))) {
            return this._NG_VALUE_ACCESSOR_1_4;
        }
        if (((token === import12.NgModel) && ((1 <= requestNodeIndex) && (requestNodeIndex <= 96)))) {
            return this._NgModel_1_5;
        }
        if (((token === import29.NgControl) && ((1 <= requestNodeIndex) && (requestNodeIndex <= 96)))) {
            return this._NgControl_1_6;
        }
        if (((token === import13.NgControlStatus) && ((1 <= requestNodeIndex) && (requestNodeIndex <= 96)))) {
            return this._NgControlStatus_1_7;
        }
        if (((token === import14.List) && ((1 <= requestNodeIndex) && (requestNodeIndex <= 96)))) {
            return this._List_1_8;
        }
        return notFoundResult;
    };
    _View_PopoverRadioPage0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        if (((this.numberOfChecks === 0) && !throwOnChange)) {
            this._RadioButton_46_4.ngOnInit();
        }
        ...
        if (((this.numberOfChecks === 0) && !throwOnChange)) {
            this._RadioButton_54_4.ngOnInit();
        }
        ...
        if (((this.numberOfChecks === 0) && !throwOnChange)) {
            this._RadioButton_62_4.ngOnInit();
        }
        ...
        if (((this.numberOfChecks === 0) && !throwOnChange)) {
            this._RadioButton_70_4.ngOnInit();
        }
        ...
        if (!throwOnChange) {
            ...
            if ((this.numberOfChecks === 0)) {
                this._Item_65_4.ngAfterContentInit();
            }
            if ((this.numberOfChecks === 0)) {
        ...
        var currVal_33 = this._RadioButton_78_4._disabled;
        ...
        var currVal_36 = this._RadioButton_86_4._disabled;
        ...
        var currVal_39 = this._RadioButton_94_4._disabled;
    ...
    _View_PopoverRadioPage0.prototype._handle_click_46_0 = function ($event) {
        ...
        var pd_0 = (this._RadioButton_46_4._click($event) !== false);
        return (true && pd_0);
    };
    _View_PopoverRadioPage0.prototype._handle_click_54_0 = function ($event) {
        ...
        var pd_0 = (this._RadioButton_54_4._click($event) !== false);
        return (true && pd_0);
    };
    _View_PopoverRadioPage0.prototype._handle_click_62_0 = function ($event) {
        ...
        var pd_0 = (this._RadioButton_62_4._click($event) !== false);
        return (true && pd_0);
    };
    _View_PopoverRadioPage0.prototype._handle_click_70_0 = function ($event) {
        ...
        var pd_0 = (this._RadioButton_70_4._click($event) !== false);
        return (true && pd_0);
    };
...
export function viewFactory_PopoverRadioPage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_PopoverRadioPage === null)) {
        (renderType_PopoverRadioPage = viewUtils.createRenderComponentType('/home/ubuntu/ionic/demos/src/popover/app.component.ts class PopoverRadioPage - inline template', 0, import9.ViewEncapsulation.None, styles_PopoverRadioPage, {}));
    }
...
var _View_ApiDemoPage0 = (function (_super) {
    ...
    _View_ApiDemoPage0.prototype.createInternal = function (rootSelector) {
        ...
        this._Header_0_3 = new import31.Header(this.parentInjector.get(import22.Config), new import21.ElementRef(this._el_0), this.renderer, this.parentInjector.get(import37.ViewController, null));
        ...
        this._Navbar_2_4 = new import32.Navbar(this.parentInjector.get(import39.App), this.parentInjector.get(import37.ViewController, null), this.parentInjector.get(import40.NavController, null), this.parentInjector.get(import22.Config), new import21.ElementRef(this._el_2), this.renderer);
        ...
        this._ToolbarTitle_4_4 = new import33.ToolbarTitle(this.parentInjector.get(import22.Config), new import21.ElementRef(this._el_4), this.renderer, this.parentInjector.get(import31.Toolbar, null), this._Navbar_2_4);
        ...
        this._ToolbarItem_7_3 = new import34.ToolbarItem(this.parentInjector.get(import22.Config), new import21.ElementRef(this._el_7), this.renderer, this.parentInjector.get(import31.Toolbar, null), this._Navbar_2_4);
        ...
        var compView_9 = import26.viewFactory_Button0(this.viewUtils, this.injector(9), this._appEl_9);
        this._Button_9_4 = new import18.Button(null, '', this.parentInjector.get(import22.Config), new import21.ElementRef(this._el_9), this.renderer);
    ...
    _View_ApiDemoPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import35.Icon) && (11 === requestNodeIndex))) {
            return this._Icon_11_3;
        }
        if (((token === import18.Button) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 12)))) {
            return this._Button_9_4;
        }
        if (((token === import34.ToolbarItem) && ((7 <= requestNodeIndex) && (requestNodeIndex <= 13)))) {
            return this._ToolbarItem_7_3;
        }
        if (((token === import32.Navbar) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 14)))) {
            return this._Navbar_2_4;
        }
        if (((token === import31.Header) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 15)))) {
            return this._Header_0_3;
        }
        if (((token === import36.Content) && ((17 <= requestNodeIndex) && (requestNodeIndex <= 36)))) {
    ...
    _View_ApiDemoPage0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        var currVal_5 = this._Icon_11_3._hidden;
        if (import4.checkBinding(throwOnChange, this._expr_5, currVal_5)) {
...
export function viewFactory_ApiDemoPage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_ApiDemoPage === null)) {
        (renderType_ApiDemoPage = viewUtils.createRenderComponentType('/home/ubuntu/ionic/demos/src/popover/page.html', 0, import9.ViewEncapsulation.None, styles_ApiDemoPage, {}));
    }
...
var _View_ApiDemoApp0 = (function (_super) {
    ...
    _View_ApiDemoApp0.prototype.createInternal = function (rootSelector) {
        ...
        this._Nav_0_4 = new import46.Nav(this.parentInjector.get(import37.ViewController, null), this.parentInjector.get(import48.NavControllerBase, null), this.parentInjector.get(import39.App), this.parentInjector.get(import22.Config), this.parentInjector.get(import43.Keyboard), new import21.ElementRef(this._el_0), this.parentInjector.get(import44.NgZone), this.renderer, this.parentInjector.get(import49.ComponentFactoryResolver), this.parentInjector.get(import23.GestureController), this.parentInjector.get(import50.TransitionController), this.parentInjector.get(import51.DeepLinker, null));
...
export function viewFactory_ApiDemoApp0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_ApiDemoApp === null)) {
        (renderType_ApiDemoApp = viewUtils.createRenderComponentType('/home/ubuntu/ionic/demos/src/popover/app.component.ts class ApiDemoApp - inline template', 0, import9.ViewEncapsulation.None, styles_ApiDemoApp, {}));
    }

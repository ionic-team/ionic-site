...
var _View_ApiDemoPage0 = (function (_super) {
    ...
    _View_ApiDemoPage0.prototype.createInternal = function (rootSelector) {
        ...
        var compView_18 = import33.viewFactory_TextArea0(this.viewUtils, this.injector(18), this._appEl_18);
        this._TextArea_18_4 = new import18.TextArea(this.parentInjector.get(import19.Config), this.parentInjector.get(import32.Form), this._Item_13_4, this.parentInjector.get(import23.App), this.parentInjector.get(import34.Platform), new import20.ElementRef(this._el_18), this.renderer, this._Content_9_4, this.parentInjector.get(import24.NavController, null), this.parentInjector.get(import35.NgControl, null));
        this._appEl_18.initComponent(this._TextArea_18_4, [], compView_18);
        compView_18.create(this._TextArea_18_4, [], null);
        ...
        var compView_26 = import33.viewFactory_TextArea0(this.viewUtils, this.injector(26), this._appEl_26);
        this._TextArea_26_4 = new import18.TextArea(this.parentInjector.get(import19.Config), this.parentInjector.get(import32.Form), this._Item_21_4, this.parentInjector.get(import23.App), this.parentInjector.get(import34.Platform), new import20.ElementRef(this._el_26), this.renderer, this._Content_9_4, this.parentInjector.get(import24.NavController, null), this.parentInjector.get(import35.NgControl, null));
        this._appEl_26.initComponent(this._TextArea_26_4, [], compView_26);
        compView_26.create(this._TextArea_26_4, [], null);
        ...
        var compView_31 = import33.viewFactory_TextArea0(this.viewUtils, this.injector(31), this._appEl_31);
        this._TextArea_31_4 = new import18.TextArea(this.parentInjector.get(import19.Config), this.parentInjector.get(import32.Form), this._Item_29_4, this.parentInjector.get(import23.App), this.parentInjector.get(import34.Platform), new import20.ElementRef(this._el_31), this.renderer, this._Content_9_4, this.parentInjector.get(import24.NavController, null), this.parentInjector.get(import35.NgControl, null));
        this._appEl_31.initComponent(this._TextArea_31_4, [], compView_31);
        compView_31.create(this._TextArea_31_4, [], null);
        ...
        var compView_39 = import33.viewFactory_TextArea0(this.viewUtils, this.injector(39), this._appEl_39);
        this._TextArea_39_4 = new import18.TextArea(this.parentInjector.get(import19.Config), this.parentInjector.get(import32.Form), this._Item_34_4, this.parentInjector.get(import23.App), this.parentInjector.get(import34.Platform), new import20.ElementRef(this._el_39), this.renderer, this._Content_9_4, this.parentInjector.get(import24.NavController, null), this.parentInjector.get(import35.NgControl, null));
        ...
        var compView_47 = import33.viewFactory_TextArea0(this.viewUtils, this.injector(47), this._appEl_47);
        this._TextArea_47_4 = new import18.TextArea(this.parentInjector.get(import19.Config), this.parentInjector.get(import32.Form), this._Item_42_4, this.parentInjector.get(import23.App), this.parentInjector.get(import34.Platform), new import20.ElementRef(this._el_47), this.renderer, this._Content_9_4, this.parentInjector.get(import24.NavController, null), this.parentInjector.get(import35.NgControl, null));
        this._appEl_47.initComponent(this._TextArea_47_4, [], compView_47);
        compView_47.create(this._TextArea_47_4, [], null);
    ...
    _View_ApiDemoPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import18.TextArea) && (18 === requestNodeIndex))) {
            return this._TextArea_18_4;
        }
        ...
        if (((token === import18.TextArea) && (26 === requestNodeIndex))) {
            return this._TextArea_26_4;
        }
        ...
        if (((token === import18.TextArea) && (31 === requestNodeIndex))) {
            return this._TextArea_31_4;
        }
        ...
        if (((token === import18.TextArea) && (39 === requestNodeIndex))) {
        ...
        if (((token === import18.TextArea) && (47 === requestNodeIndex))) {
            return this._TextArea_47_4;
        }
        ...
        if (((token === import14.List) && ((11 <= requestNodeIndex) && (requestNodeIndex <= 49)))) {
            return this._List_11_3;
        }
        if (((token === import13.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 50)))) {
    ...
    _View_ApiDemoPage0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        if (import4.checkBinding(throwOnChange, this._expr_4, currVal_4)) {
            this._TextArea_18_4.placeholder = currVal_4;
            this._expr_4 = currVal_4;
        }
        if (((this.numberOfChecks === 0) && !throwOnChange)) {
            this._TextArea_18_4.ngOnInit();
        }
        ...
        if (import4.checkBinding(throwOnChange, this._expr_6, currVal_6)) {
            this._TextArea_26_4.placeholder = currVal_6;
            this._expr_6 = currVal_6;
        }
        if (((this.numberOfChecks === 0) && !throwOnChange)) {
            this._TextArea_26_4.ngOnInit();
        }
        var currVal_7 = 'Textarea with no label';
        if (import4.checkBinding(throwOnChange, this._expr_7, currVal_7)) {
            this._TextArea_31_4.placeholder = currVal_7;
            this._expr_7 = currVal_7;
        }
        if (((this.numberOfChecks === 0) && !throwOnChange)) {
            this._TextArea_31_4.ngOnInit();
        }
        var currVal_8 = 'primary';
        if (import4.checkBinding(throwOnChange, this._expr_8, currVal_8)) {
            this._Label_36_3.color = currVal_8;
            this._expr_8 = currVal_8;
        }
        var currVal_9 = 'Textarea';
        if (import4.checkBinding(throwOnChange, this._expr_9, currVal_9)) {
            this._TextArea_39_4.placeholder = currVal_9;
        ...
        if (import4.checkBinding(throwOnChange, this._expr_10, currVal_10)) {
            this._Label_44_3.color = currVal_10;
            this._expr_10 = currVal_10;
        }
        if (((this.numberOfChecks === 0) && !throwOnChange)) {
            this._TextArea_47_4.ngOnInit();
        }
        ...
        if (!throwOnChange) {
            ...
            this._TextArea_18_4.ngAfterContentChecked();
            if ((this.numberOfChecks === 0)) {
                this._Item_13_4.ngAfterContentInit();
            }
            this._TextArea_26_4.ngAfterContentChecked();
            if ((this.numberOfChecks === 0)) {
                this._Item_21_4.ngAfterContentInit();
            }
            this._TextArea_31_4.ngAfterContentChecked();
            if ((this.numberOfChecks === 0)) {
                this._Item_29_4.ngAfterContentInit();
            }
            this._TextArea_39_4.ngAfterContentChecked();
            if ((this.numberOfChecks === 0)) {
                this._Item_34_4.ngAfterContentInit();
            }
            this._TextArea_47_4.ngAfterContentChecked();
            if ((this.numberOfChecks === 0)) {
    ...
    _View_ApiDemoPage0.prototype.destroyInternal = function () {
        this._TextArea_18_4.ngOnDestroy();
        this._TextArea_26_4.ngOnDestroy();
        this._TextArea_31_4.ngOnDestroy();
        this._TextArea_39_4.ngOnDestroy();
        this._TextArea_47_4.ngOnDestroy();
...
export function viewFactory_ApiDemoPage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_ApiDemoPage === null)) {
        (renderType_ApiDemoPage = viewUtils.createRenderComponentType('/home/ubuntu/ionic/demos/src/textarea/page.html', 0, import8.ViewEncapsulation.None, styles_ApiDemoPage, {}));
    }
...
export function viewFactory_ApiDemoApp0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_ApiDemoApp === null)) {
        (renderType_ApiDemoApp = viewUtils.createRenderComponentType('/home/ubuntu/ionic/demos/src/textarea/app.component.ts class ApiDemoApp - inline template', 0, import8.ViewEncapsulation.None, styles_ApiDemoApp, {}));
    }

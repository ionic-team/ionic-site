...
router: app => {
  ...
  .get('/resources/customer-interviews/:customerStory', getPrismicAPI, (req, res, next) =>
    getPrismic(req, res, next, 'customer_stories', req.params['customerInterview'], 'resources/customer-interviews'))

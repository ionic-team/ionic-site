...
export class Overlay {
  ...
  create(overlayType, ComponentType, opts) {
...
Object.defineProperty(Overlay, "parameters", {get: function() {
    return [[IonicApp]];
  }});
Object.defineProperty(Overlay.prototype.create, "parameters", {get: function() {
    return [[], [Type], []];
  }});

...
export class View_ApiDemoPage0 extends import83.AppView<import1.ApiDemoPage> {
  ...
  createInternal(rootSelector:string):import89.ComponentRef<any> {
    ...
    this._el_11 = import85.createRenderElement(this.renderer,(null as any),'ion-scroll',new import85.InlineArray8(6,'scrollX','true','scrollY','true','style','width: 100%; height: 100%'),(null as any));
    ...
    this._el_13 = import85.createRenderElement(this.renderer,(null as any),'div',new import85.InlineArray2(2,'class','map-div'),(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import103.Scroll) && ((11 <= requestNodeIndex) && (requestNodeIndex <= 14)))) { return this._Scroll_11_3.context; }
    if (((token === import101.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 15)))) { return this._Content_9_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {

System.register('rxjs/src/operators/toArray', ['../Subscriber'], function (_export) {
    'use strict';

    var Subscriber, ToArrayOperator, ToArraySubscriber;
    ...
    return {
        ...
        execute: function () {
            ...
            ToArraySubscriber = (function (_Subscriber) {
                _inherits(ToArraySubscriber, _Subscriber);

                function ToArraySubscriber(destination) {
                    _classCallCheck(this, ToArraySubscriber);

                    _get(Object.getPrototypeOf(ToArraySubscriber.prototype), 'constructor', this).call(this, destination);
                    this.array = [];
                }

...
<a href='https://github.com/ionic-team/ionic-v1/blob/master/js/angular/directive/navView.js#L1'>
View Source
</a>
&nbsp;
<a href='http://github.com/ionic-team/ionic/edit/1.x/js/angular/directive/navView.js#L1'>
Improve this doc
</a>
</div>
...
the <a href="/docs/v1/nightly/api/directive/ionNavBar/"><code>ionNavBar</code></a> directive that updates as we navigate through the
navigation stack.
...
<a href="/docs/v1/nightly/api/directive/ionView/"><code>ionView</code></a> scope, such as `$ionicView.enter`, may be useful.
...
<a href="/docs/v1/nightly/api/provider/$ionicConfigProvider/"><code>$ionicConfigProvider</code></a>:
...
The <a href="/docs/v1/nightly/api/provider/$ionicConfigProvider/"><code>$ionicConfigProvider</code></a> can be used to set the maximum allowable views

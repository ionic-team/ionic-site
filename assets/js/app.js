...
.controller('ProductsPageCtrl', ['$scope', '$timeout', function($scope, $timeout){
  ...
  $scope.gotoPricing = function(location){
    mixpanel.track('Pricing Button Click', { 'test': 'ProductsTest - 5', 'location': location });
    $timeout(function(){
  ...
  $scope.gotoGettingStarted = function(){
    mixpanel.track('Community - Getting Started Click', { 'test': 'ProductsTest - 5' });
    $timeout(function(){
  ...
  $scope.trackOpenSurvey = function(){
    mixpanel.track('Professional - Im Interested Click', { 'test': 'ProductsTest - 5' });
    c('Pricing','FormOpen')
  }

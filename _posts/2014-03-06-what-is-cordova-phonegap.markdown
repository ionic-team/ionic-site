...
So what is the difference between Cordova and PhoneGap? One helpful analogy Adobe uses is Cordova is to PhoneGap as WebKit (now Blink) is to Chrome. PhoneGap is Cordova plus extra Adobe stuff.

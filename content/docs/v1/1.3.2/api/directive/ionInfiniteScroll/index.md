...
&nbsp;
<a href='https://github.com/ionic-team/ionic-v1/edit/master/js/angular/directive/infiniteScroll.js#L1'>
Improve this doc
</a>
</div>
...
reach to trigger the on-infinite expression. Default: 1%.</p>
  ...
  <code>string</code>
      ...
      <td>
        <p>The <a href="/docs/v1/api/directive/ionSpinner/"><code>ionSpinner</code></a> to show while loading. The SVG
<a href="/docs/v1/api/directive/ionSpinner/"><code>ionSpinner</code></a> is now the default, replacing rotating font icons.</p>
...
in favor of the SVG <a href="/docs/v1/api/directive/ionSpinner/"><code>ionSpinner</code></a>.</p>

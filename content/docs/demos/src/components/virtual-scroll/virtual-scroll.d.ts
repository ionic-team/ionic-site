import { AfterContentInit, ChangeDetectorRef, DoCheck, ElementRef, IterableDiffers, IterableDiffer, NgZone, OnDestroy, Renderer, TrackByFn } from '@angular/core';
 ...
 * [WKWebView plugin](http://blog.ionicframework.com/cordova-ios-performance-improvements-drop-in-speed-with-wkwebview/)
...
export declare class VirtualScroll implements DoCheck, AfterContentInit, OnDestroy {
    ...
    constructor(_iterableDiffers: IterableDiffers, _elementRef: ElementRef, _renderer: Renderer, _zone: NgZone, _cd: ChangeDetectorRef, _content: Content, _platform: Platform, _ctrl: ViewController, _config: Config, _dom: DomController);
    /**
     * @private
     */
    ngDoCheck(): void;

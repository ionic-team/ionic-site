...
export var View_ApiDemoPage0 = (function (_super) {
    ...
    View_ApiDemoPage0.prototype.createInternal = function (rootSelector) {
        ...
        this._el_11 = import85.createRenderElement(this.renderer, null, 'button', new import85.InlineArray4(4, 'block', '', 'ion-button', ''), null);
        this.compView_11 = new import104.View_Button0(this.viewUtils, this, 11, this._el_11);
        this._Button_11_3 = new import104.Wrapper_Button('', this.parentView.injectorGet(import68.Config, this.parentIndex), new import94.ElementRef(this._el_11), this.renderer);
        this._text_12 = this.renderer.createText(null, 'Show Toast Bottom Position', null);
        this.compView_11.create(this._Button_11_3.context);
        this._text_13 = this.renderer.createText(null, '\n  ', null);
        this._el_14 = import85.createRenderElement(this.renderer, null, 'button', new import85.InlineArray4(4, 'block', '', 'ion-button', ''), null);
        ...
        this._el_17 = import85.createRenderElement(this.renderer, null, 'button', new import85.InlineArray4(4, 'block', '', 'ion-button', ''), null);
        ...
        this._el_20 = import85.createRenderElement(this.renderer, null, 'button', new import85.InlineArray8(6, 'block', '', 'ion-button', '', 'margin-bottom', ''), null);
        ...
        this._el_23 = import85.createRenderElement(this.renderer, null, 'button', new import85.InlineArray4(4, 'block', '', 'ion-button', ''), null);
        ...
        this._el_26 = import85.createRenderElement(this.renderer, null, 'button', new import85.InlineArray4(4, 'block', '', 'ion-button', ''), null);
        ...
        var disposable_0 = import85.subscribeToRenderElement(this, this._el_11, new import85.InlineArray2(2, 'click', null), this.eventHandler(this.handleEvent_11));
        var disposable_1 = import85.subscribeToRenderElement(this, this._el_14, new import85.InlineArray2(2, 'click', null), this.eventHandler(this.handleEvent_14));
        var disposable_2 = import85.subscribeToRenderElement(this, this._el_17, new import85.InlineArray2(2, 'click', null), this.eventHandler(this.handleEvent_17));
        var disposable_3 = import85.subscribeToRenderElement(this, this._el_20, new import85.InlineArray2(2, 'click', null), this.eventHandler(this.handleEvent_20));
        var disposable_4 = import85.subscribeToRenderElement(this, this._el_23, new import85.InlineArray2(2, 'click', null), this.eventHandler(this.handleEvent_23));
        var disposable_5 = import85.subscribeToRenderElement(this, this._el_26, new import85.InlineArray2(2, 'click', null), this.eventHandler(this.handleEvent_26));
    ...
    View_ApiDemoPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import103.Button) && ((11 <= requestNodeIndex) && (requestNodeIndex <= 12)))) {
            return this._Button_11_3.context;
        }
        ...
        if (((token === import101.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 28)))) {
    ...
    View_ApiDemoPage0.prototype.handleEvent_11 = function (eventName, $event) {
        this.markPathToRootAsCheckOnce();
        var result = true;
        if ((eventName == 'click')) {
            var pd_sub_0 = (this.context.showToast('bottom') !== false);
            result = (pd_sub_0 && result);
        }
        return result;
    };
    View_ApiDemoPage0.prototype.handleEvent_14 = function (eventName, $event) {
        this.markPathToRootAsCheckOnce();
        var result = true;
        if ((eventName == 'click')) {
            var pd_sub_0 = (this.context.showToast('top') !== false);
            result = (pd_sub_0 && result);
        }
        return result;
    };
    View_ApiDemoPage0.prototype.handleEvent_17 = function (eventName, $event) {
        this.markPathToRootAsCheckOnce();
        var result = true;
        if ((eventName == 'click')) {
            var pd_sub_0 = (this.context.showToast('middle') !== false);
            result = (pd_sub_0 && result);
        }
        return result;
    };
    View_ApiDemoPage0.prototype.handleEvent_20 = function (eventName, $event) {
        this.markPathToRootAsCheckOnce();
        var result = true;
        if ((eventName == 'click')) {
            var pd_sub_0 = (this.context.showLongToast() !== false);
            result = (pd_sub_0 && result);
        }
        return result;
    };
    View_ApiDemoPage0.prototype.handleEvent_23 = function (eventName, $event) {
        ...
        var result = true;
        if ((eventName == 'click')) {
            var pd_sub_0 = (this.context.showDismissDurationToast() !== false);
            result = (pd_sub_0 && result);
        }
        return result;
    };
    View_ApiDemoPage0.prototype.handleEvent_26 = function (eventName, $event) {
        ...
        var result = true;
        if ((eventName == 'click')) {
            var pd_sub_0 = (this.context.showToastWithCloseButton() !== false);
            result = (pd_sub_0 && result);
        }
        return result;
    };

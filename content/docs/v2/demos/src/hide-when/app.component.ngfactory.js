...
var _View_ApiDemoPage0 = (function (_super) {
    ...
    _View_ApiDemoPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import29.HideWhen) && (26 === requestNodeIndex))) {
            return this._HideWhen_26_3.context;
        }
        if (((token === import30.Icon) && (26 === requestNodeIndex))) {
            return this._Icon_26_4.context;
        }
        ...
        if (((token === import29.HideWhen) && (40 === requestNodeIndex))) {
            return this._HideWhen_40_3.context;
        }
        if (((token === import30.Icon) && (40 === requestNodeIndex))) {
            return this._Icon_40_4.context;
        }
        ...
        if (((token === import29.HideWhen) && (54 === requestNodeIndex))) {
            return this._HideWhen_54_3.context;
        }
        if (((token === import30.Icon) && (54 === requestNodeIndex))) {
            return this._Icon_54_4.context;
        }

...
Object.defineProperty(ItemPrimarySwipeButtons, "annotations", {get: function() {
    return [new Directive({selector: 'ion-primary-swipe-buttons'})];
  }});
Object.defineProperty(ItemPrimarySwipeButtons, "parameters", {get: function() {
    return [[ElementRef], [Item, new Parent()]];
  }});
export class ItemSecondarySwipeButtons {}
Object.defineProperty(ItemSecondarySwipeButtons, "annotations", {get: function() {

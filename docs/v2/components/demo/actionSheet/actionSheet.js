System.register("actionSheet/actionSheet", ["ionic/ionic"], function (_export) {
    ...
    var IonicPlatform, Page, ActionSheet, __decorate, __metadata, ActionSheetPage, _a, _b;
    ...
    return {
        ...
        execute: function () {
            ...
            _export("ActionSheetPage", ActionSheetPage = __decorate([Page({
                templateUrl: 'actionSheet/actionSheet.html'
            }), __metadata('design:paramtypes', [typeof (_a = typeof ActionSheet !== 'undefined' && ActionSheet) === 'function' && _a || Object, typeof (_b = typeof IonicPlatform !== 'undefined' && IonicPlatform) === 'function' && _b || Object])], ActionSheetPage));
        }
    };
});
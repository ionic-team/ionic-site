...
export class ViewController {
  constructor(parentViewCtrl, compiler, elementRef, loader, injector) {
  ...
  swipeBackStart() {
    ...
    enteringItem.stage(() => {
      ...
      let swipeBackPromise = new Promise((res) => {
        this.sbResolve = res;
      });
...
Object.defineProperty(ViewController, "parameters", {get: function() {

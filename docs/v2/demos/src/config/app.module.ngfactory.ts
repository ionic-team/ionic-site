...
class AppModuleInjector extends import0.NgModuleInjector<import1.AppModule> {
  ...
  get _APP_ID_29():any {
    if ((this.__APP_ID_29 == (null as any))) { (this.__APP_ID_29 = import54._appIdRandomProviderFactory()); }
  ...
  get _EventManager_33():import16.EventManager {
    if ((this.__EventManager_33 == (null as any))) { (this.__EventManager_33 = new import16.EventManager(this._EVENT_MANAGER_PLUGINS_32,this.parent.get(import58.NgZone))); }
  ...
  get _RootRenderer_37():any {
    if ((this.__RootRenderer_37 == (null as any))) { (this.__RootRenderer_37 = import59._createConditionalRootRenderer(this._DomRootRenderer_36,this.parent.get(import59.NgProbeToken,(null as any)))); }
  ...
  get _AppRootToken_53():any {
    if ((this.__AppRootToken_53 == (null as any))) { (this.__AppRootToken_53 = import60.ApiDemoApp); }
  ...
  get _Keyboard_60():import33.Keyboard {
    if ((this.__Keyboard_60 == (null as any))) { (this.__Keyboard_60 = new import33.Keyboard(this._Config_21,this._Form_58,this.parent.get(import58.NgZone))); }
  ...
  get _LocationStrategy_62():any {
    if ((this.__LocationStrategy_62 == (null as any))) { (this.__LocationStrategy_62 = import8.provideLocationStrategy(this.parent.get(import61.PlatformLocation),this.parent.get(import62.APP_BASE_HREF,(null as any)),this._Config_21)); }
  ...
  get _TapClick_68():import40.TapClick {
    if ((this.__TapClick_68 == (null as any))) { (this.__TapClick_68 = new import40.TapClick(this._Config_21,this._App_22,this.parent.get(import58.NgZone))); }
  ...
  get _UrlSerializer_72():any {
    if ((this.__UrlSerializer_72 == (null as any))) { (this.__UrlSerializer_72 = import63.setupUrlSerializer(this._DeepLinkConfigToken_54)); }
    return this.__UrlSerializer_72;
  }
  get _DeepLinker_73():any {
    if ((this.__DeepLinker_73 == (null as any))) { (this.__DeepLinker_73 = import64.setupDeepLinker(this._App_22,this._UrlSerializer_72,this._Location_63)); }
  ...
  createInternal():import1.AppModule {
    ...
    this._ApplicationRef__26 = new import13.ApplicationRef_(this.parent.get(import58.NgZone),this.parent.get(import71.Console),this,this._ErrorHandler_11,this,this._ApplicationInitStatus_24,this.parent.get(import12.TestabilityRegistry,(null as any)),this._Testability_25);
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import54.APP_ID)) { return this._APP_ID_29; }
    if ((token === import74.DOCUMENT)) { return this._DOCUMENT_30; }
    if ((token === import57.HAMMER_GESTURE_CONFIG)) { return this._HAMMER_GESTURE_CONFIG_31; }
    ...
    if ((token === import75.AnimationDriver)) { return this._AnimationDriver_35; }
    if ((token === import18.DomRootRenderer)) { return this._DomRootRenderer_36; }
    if ((token === import76.RootRenderer)) { return this._RootRenderer_37; }
    if ((token === import19.DomSanitizer)) { return this._DomSanitizer_38; }
    if ((token === import77.Sanitizer)) { return this._Sanitizer_39; }
    if ((token === import20.ViewUtils)) { return this._ViewUtils_40; }
    if ((token === import78.IterableDiffers)) { return this._IterableDiffers_41; }
    if ((token === import79.KeyValueDiffers)) { return this._KeyValueDiffers_42; }
    ...
    if ((token === import82.AppRootToken)) { return this._AppRootToken_53; }
    if ((token === import63.DeepLinkConfigToken)) { return this._DeepLinkConfigToken_54; }
    ...
    if ((token === import62.LocationStrategy)) { return this._LocationStrategy_62; }
    ...
    if ((token === import63.UrlSerializer)) { return this._UrlSerializer_72; }
    if ((token === import64.DeepLinker)) { return this._DeepLinker_73; }

...
export class View_ApiDemoPage0 extends import83.AppView<import1.ApiDemoPage> {
  ...
  _text_1:any;
  _anchor_2:any;
  /*private*/ _vc_2:import98.ViewContainer;
  ...
  constructor(viewUtils:import85.ViewUtils,parentView:import83.AppView<any>,parentIndex:number,parentElement:any) {
    ...
    this._arr_10 = import85.pureProxy5((p0:any,p1:any,p2:any,p3:any,p4:any):any[] => {
      return [
        p0,
        p1,
        p2,
  ...
  createInternal(rootSelector:string):import89.ComponentRef<any> {
    const parentRenderNode:any = this.renderer.createViewRoot(this.parentElement);
    this._el_0 = import85.createRenderElement(this.renderer,parentRenderNode,'ion-slides',new import85.InlineArray4(4,'loop','true','style','background-color: black'),(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import100.TemplateRef) && (2 === requestNodeIndex))) { return this._TemplateRef_2_5; }
    if (((token === import101.NgFor) && (2 === requestNodeIndex))) { return this._NgFor_2_6.context; }
    if (((token === import96.Slides) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 3)))) { return this._Slides_0_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    if (this._Slides_0_3.ngDoCheck(this,this._el_0,throwOnChange)) { this.compView_0.markAsCheckOnce(); }
    const currVal_2_0_0:any = this._arr_10(1,2,3,4,5);
  ...
  createEmbeddedViewInternal(nodeIndex:number):import83.AppView<any> {
    if ((nodeIndex == 2)) { return new View_ApiDemoPage1(this.viewUtils,this,2,this._anchor_2,this._vc_2); }
    return (null as any);
  }
}
class View_ApiDemoPage1 extends import83.AppView<any> {
  _el_0:any;
  compView_0:import83.AppView<import96.Slide>;
  _Slide_0_3:import97.Wrapper_Slide;
  _text_1:any;
  _el_2:any;
  _text_3:any;
  /*private*/ _expr_6:any;
  constructor(viewUtils:import85.ViewUtils,parentView:import83.AppView<any>,parentIndex:number,parentElement:any,declaredViewContainer:import98.ViewContainer) {
  ...
  createInternal(rootSelector:string):import89.ComponentRef<any> {
    this._el_0 = import85.createRenderElement(this.renderer,(null as any),'ion-slide',import85.EMPTY_INLINE_ARRAY,(null as any));
    this.compView_0 = new import97.View_Slide0(this.viewUtils,this,0,this._el_0);
    this._Slide_0_3 = new import97.Wrapper_Slide(new import94.ElementRef(this._el_0),(<View_ApiDemoPage0>this.parentView)._Slides_0_3.context);
    this._text_1 = this.renderer.createText((null as any),'\n    ',(null as any));
    this._el_2 = import85.createRenderElement(this.renderer,(null as any),'img',import85.EMPTY_INLINE_ARRAY,(null as any));
    this._text_3 = this.renderer.createText((null as any),'\n  ',(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import96.Slide) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 3)))) { return this._Slide_0_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    if (this._Slide_0_3.ngDoCheck(this,this._el_0,throwOnChange)) { this.compView_0.markAsCheckOnce(); }
    const currVal_6:any = import85.inlineInterpolate(1,'./slide',this.context.$implicit,'.jpeg');

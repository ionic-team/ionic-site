...
System.register('ionic/ionic', ['ionic/config/config', 'ionic/config/component', 'ionic/config/ionic-view', 'ionic/net/http', 'ionic/registry', 'ionic/components', 'ionic/platform/platform', 'ionic/platform/registry', 'ionic/routing/router', 'ionic/util/click-block', 'ionic/util/focus', 'ionic/util/tap', 'ionic/animations/animation', 'ionic/animations/builtins', 'ionic/transitions/transition', 'ionic/transitions/ios-transition'], function (_export) {
  ...
  return {
    setters: [function (_ionicConfigConfig) {
      ...
      for (var _key4 in _ionicNetHttp) {
        _export(_key4, _ionicNetHttp[_key4]);
      }
    }, function (_ionicRegistry) {
      for (var _key5 in _ionicRegistry) {
        _export(_key5, _ionicRegistry[_key5]);
      }
    }, function (_ionicComponents) {
      for (var _key6 in _ionicComponents) {
        _export(_key6, _ionicComponents[_key6]);
      }
    }, function (_ionicPlatformPlatform) {
      for (var _key7 in _ionicPlatformPlatform) {
        _export(_key7, _ionicPlatformPlatform[_key7]);
      }
    }, function (_ionicPlatformRegistry) {
      for (var _key8 in _ionicPlatformRegistry) {
        _export(_key8, _ionicPlatformRegistry[_key8]);
      }
    }, function (_ionicRoutingRouter) {
      for (var _key9 in _ionicRoutingRouter) {
        _export(_key9, _ionicRoutingRouter[_key9]);
      }

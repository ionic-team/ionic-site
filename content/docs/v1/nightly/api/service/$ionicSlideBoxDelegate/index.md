...
Delegate that controls the <a href="/docs/v1/nightly/api/directive/ionSlideBox/"><code>ionSlideBox</code></a> directive.

Methods called directly on the $ionicSlideBoxDelegate service will control all slide boxes.  Use the <a href="/docs/v1/nightly/api/service/$ionicSlideBoxDelegate/#$getByHandle">$getByHandle</a>
...
<a href="/docs/v1/nightly/api/directive/ionSlideBox/"><code>ionSlideBox</code></a> directives with `delegate-handle` matching
the given handle.

...
class _View_ApiDemoPage0 extends import1.AppView<import3.ApiDemoPage> {
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import38.NG_VALUE_ACCESSOR) && ((11 <= requestNodeIndex) && (requestNodeIndex <= 47)))) { return this._NG_VALUE_ACCESSOR_11_5; }
    ...
    if (((token === import38.NG_VALUE_ACCESSOR) && (59 === requestNodeIndex))) { return this._NG_VALUE_ACCESSOR_59_5; }
    ...
    if (((token === import38.NG_VALUE_ACCESSOR) && ((49 <= requestNodeIndex) && (requestNodeIndex <= 93)))) { return this._NG_VALUE_ACCESSOR_49_5; }
    ...
    if (((token === import38.NG_VALUE_ACCESSOR) && ((95 <= requestNodeIndex) && (requestNodeIndex <= 115)))) { return this._NG_VALUE_ACCESSOR_95_5; }
...
class _View_ApiDemoApp0 extends import1.AppView<import3.ApiDemoApp> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._Nav_0_4 = new import39.Nav(this.parentInjector.get(import24.ViewController,(null as any)),this.parentInjector.get(import41.NavControllerBase,(null as any)),this.parentInjector.get(import26.App),this.parentInjector.get(import22.Config),this.parentInjector.get(import30.Keyboard),new import23.ElementRef(this._el_0),this.parentInjector.get(import31.NgZone),this.renderer,this.parentInjector.get(import42.ComponentFactoryResolver),this.parentInjector.get(import33.GestureController),this.parentInjector.get(import43.TransitionController),this.parentInjector.get(import44.DeepLinker,(null as any)));

...
import * as import103 from '../components/refresher/refresher.ngfactory';
import * as import104 from '../components/refresher/refresher-content';
import * as import105 from '../components/refresher/refresher-content.ngfactory';
...
import * as import112 from '../components/refresher/refresher';
import * as import113 from '@angular/common/src/directives/ng_for';
...
var View_ApiDemoPage_Host0 = (function (_super) {
    ...
    View_ApiDemoPage_Host0.prototype.createInternal = function (rootSelector) {
        ...
        this._MockProvider_0_3 = new import1.MockProvider();
        this._ApiDemoPage_0_4 = new Wrapper_ApiDemoPage(this._MockProvider_0_3);
        this.compView_0.create(this._ApiDemoPage_0_4.context);
        this.init(this._el_0, (this.renderer.directRenderer ? null : [this._el_0]), null);
        return new import89.ComponentRef_(0, this, this._el_0, this._ApiDemoPage_0_4.context);
    };
    View_ApiDemoPage_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import1.MockProvider) && (0 === requestNodeIndex))) {
            return this._MockProvider_0_3;
        }
    ...
    View_ApiDemoPage_Host0.prototype.detectChangesInternal = function (throwOnChange) {
        this._ApiDemoPage_0_4.ngDoCheck(this, this._el_0, throwOnChange);
        this.compView_0.detectChanges(throwOnChange);
    };
...
export var View_ApiDemoPage0 = (function (_super) {
    ...
    View_ApiDemoPage0.prototype.createInternal = function (rootSelector) {
        ...
        this._el_11 = import85.createRenderElement(this.renderer, null, 'ion-refresher', import85.EMPTY_INLINE_ARRAY, null);
        this._Refresher_11_3 = new import103.Wrapper_Refresher(this._Content_9_3.context, this.parentView.injectorGet(import59.NgZone, this.parentIndex), this.parentView.injectorGet(import13.GestureController, this.parentIndex));
        this._text_12 = this.renderer.createText(this._el_11, '\n    ', null);
        this._el_13 = import85.createRenderElement(this.renderer, this._el_11, 'ion-refresher-content', new import85.InlineArray4(4, 'pullingText', 'Pull to refresh...', 'refreshingText', 'Refreshing...'), null);
        this.compView_13 = new import105.View_RefresherContent0(this.viewUtils, this, 13, this._el_13);
        this._RefresherContent_13_3 = new import105.Wrapper_RefresherContent(this._Refresher_11_3.context, this.parentView.injectorGet(import68.Config, this.parentIndex));
        this._text_14 = this.renderer.createText(null, '\n    ', null);
        this.compView_13.create(this._RefresherContent_13_3.context);
        this._text_15 = this.renderer.createText(this._el_11, '\n  ', null);
        this._text_16 = this.renderer.createText(null, '\n\n  ', null);
        this._el_17 = import85.createRenderElement(this.renderer, null, 'ion-list', import85.EMPTY_INLINE_ARRAY, null);
        this._List_17_3 = new import106.Wrapper_List(this.parentView.injectorGet(import68.Config, this.parentIndex), new import94.ElementRef(this._el_17), this.renderer, this.parentView.injectorGet(import13.GestureController, this.parentIndex), this.parentView.injectorGet(import10.DomController, this.parentIndex));
        this._text_18 = this.renderer.createText(this._el_17, '\n    ', null);
        this._anchor_19 = this.renderer.createTemplateAnchor(this._el_17, null);
        this._vc_19 = new import107.ViewContainer(19, 17, this, this._anchor_19);
        this._TemplateRef_19_5 = new import111.TemplateRef_(this, 19, this._anchor_19);
        this._NgFor_19_6 = new import108.Wrapper_NgFor(this._vc_19.vcRef, this._TemplateRef_19_5, this.parentView.injectorGet(import78.IterableDiffers, this.parentIndex), this.ref);
        ...
        var disposable_0 = import85.subscribeToRenderElement(this, this._el_11, new import85.InlineArray4(4, 'ionRefresh', null, 'ionPull', null), this.eventHandler(this.handleEvent_11));
        this._Refresher_11_3.subscribe(this, this.eventHandler(this.handleEvent_11), true, true, false);
    ...
    View_ApiDemoPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import104.RefresherContent) && ((13 <= requestNodeIndex) && (requestNodeIndex <= 14)))) {
            return this._RefresherContent_13_3.context;
        }
        if (((token === import112.Refresher) && ((11 <= requestNodeIndex) && (requestNodeIndex <= 15)))) {
            return this._Refresher_11_3.context;
        }
        if (((token === import111.TemplateRef) && (19 === requestNodeIndex))) {
            return this._TemplateRef_19_5;
        }
        if (((token === import113.NgFor) && (19 === requestNodeIndex))) {
            return this._NgFor_19_6.context;
        }
        if (((token === import114.List) && ((17 <= requestNodeIndex) && (requestNodeIndex <= 20)))) {
    ...
    View_ApiDemoPage0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        this._Refresher_11_3.ngDoCheck(this, this._el_11, throwOnChange);
        var currVal_13_0_0 = 'Pull to refresh...';
        this._RefresherContent_13_3.check_pullingText(currVal_13_0_0, throwOnChange, false);
        var currVal_13_0_1 = 'Refreshing...';
        this._RefresherContent_13_3.check_refreshingText(currVal_13_0_1, throwOnChange, false);
        this._RefresherContent_13_3.ngDoCheck(this, this._el_13, throwOnChange);
        this._List_17_3.ngDoCheck(this, this._el_17, throwOnChange);
        var currVal_19_0_0 = this.context.items;
        ...
        this._Refresher_11_3.checkHost(this, this, this._el_11, throwOnChange);
        this._RefresherContent_13_3.checkHost(this, this.compView_13, this._el_13, throwOnChange);
    ...
    View_ApiDemoPage0.prototype.createEmbeddedViewInternal = function (nodeIndex) {
        if ((nodeIndex == 19)) {
            return new View_ApiDemoPage1(this.viewUtils, this, 19, this._anchor_19, this._vc_19);
        }
        return null;
    };
    View_ApiDemoPage0.prototype.handleEvent_11 = function (eventName, $event) {
        ...
        var result = true;
        if ((eventName == 'ionRefresh')) {
            var pd_sub_0 = (this.context.doRefresh($event) !== false);
            result = (pd_sub_0 && result);
        }
        if ((eventName == 'ionPull')) {
            var pd_sub_1 = (this.context.doPulling($event) !== false);

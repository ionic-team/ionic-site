...
defined in <a href="https://github.com/driftyco/ionic2/tree/master/ionic/components/text-input/text-input.ts#L395-L508">ionic/components/text-input/text-input.ts (line 395)</a>
</p>
<h2>Directive</h2>

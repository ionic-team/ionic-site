...
export class View_ApiDemoPage0 extends import83.AppView<import1.ApiDemoPage> {
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import101.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 13)))) { return this._Content_9_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
...
export class View_PushPage0 extends import83.AppView<import1.PushPage> {
  ...
  createInternal(rootSelector:string):import89.ComponentRef<any> {
    ...
    this.compView_11.create(this._Button_11_3.context);
    this._text_13 = this.renderer.createText((null as any),'\n  ',(null as any));
    this._el_14 = import85.createRenderElement(this.renderer,(null as any),'button',new import85.InlineArray8(6,'block','','color','secondary','ion-button',''),(null as any));
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    this._Navbar_2_3.checkHost(this,this.compView_2,this._el_2,throwOnChange);
    const currVal_29:any = import85.inlineInterpolate(1,'Page ',this.context.pageNum,'');

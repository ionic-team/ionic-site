System.register('rxjs/src/observables/ForkJoinObservable', ['../Observable', '../Subscriber'], function (_export) {
    'use strict';

    var Observable, Subscriber, ForkJoinObservable, AllSubscriber;
    ...
    return {
        ...
        execute: function () {
            ...
            _export('default', ForkJoinObservable);

            AllSubscriber = (function (_Subscriber) {
                ...
                function AllSubscriber(destination, parent, index, context) {
                    ...
                    _get(Object.getPrototypeOf(AllSubscriber.prototype), 'constructor', this).call(this, destination);
                    this.parent = parent;
                    this.index = index;

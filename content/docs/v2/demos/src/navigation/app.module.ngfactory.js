...
import * as import62 from './url-serializer';
import * as import63 from './deep-linker';
...
import * as import91 from './view-controller';
import * as import92 from './nav-controller';
...
export var View_ApiDemoPage0 = (function (_super) {
    ...
    View_ApiDemoPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import100.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 13)))) {
...
export var View_PushPage0 = (function (_super) {
    ...
    function View_PushPage0(viewUtils, parentView, parentIndex, parentElement) {
        ...
        this._expr_29 = import87.UNINITIALIZED;
    }
    View_PushPage0.prototype.createInternal = function (rootSelector) {
        ...
        this.compView_11.create(this._Button_11_3.context);
        this._text_13 = this.renderer.createText(null, '\n  ', null);
        this._el_14 = import84.createRenderElement(this.renderer, null, 'button', new import84.InlineArray8(6, 'block', '', 'color', 'secondary', 'ion-button', ''), null);
    ...
    View_PushPage0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        this._Navbar_2_3.checkHost(this, this.compView_2, this._el_2, throwOnChange);
        var currVal_29 = import84.inlineInterpolate(1, 'Page ', this.context.pageNum, '');
        if (import84.checkBinding(throwOnChange, this._expr_29, currVal_29)) {

...
export var View_ApiDemoPage0 = (function (_super) {
    ...
    View_ApiDemoPage0.prototype.createInternal = function (rootSelector) {
        ...
        this._el_11 = import84.createRenderElement(this.renderer, null, 'ion-list', new import84.InlineArray2(2, 'no-margin', ''), null);
        ...
        this._el_21 = import84.createRenderElement(this.renderer, null, 'ion-select', new import84.InlineArray2(2, 'multiple', 'true'), null);
        ...
        this._el_23 = import84.createRenderElement(this.renderer, null, 'ion-option', new import84.InlineArray2(2, 'value', 'Bangkok'), null);
        ...
        this._el_26 = import84.createRenderElement(this.renderer, null, 'ion-option', new import84.InlineArray2(2, 'value', 'Nonthaburi'), null);
        ...
        this._el_29 = import84.createRenderElement(this.renderer, null, 'ion-option', new import84.InlineArray2(2, 'value', 'Nakhon Ratchasima'), null);
        ...
        this._el_32 = import84.createRenderElement(this.renderer, null, 'ion-option', new import84.InlineArray2(2, 'value', 'Chiang Mai'), null);
        ...
        this._el_38 = import84.createRenderElement(this.renderer, null, 'div', new import84.InlineArray2(2, 'padding', ''), null);
        this._text_39 = this.renderer.createText(this._el_38, '\n    ', null);
        this._el_40 = import84.createRenderElement(this.renderer, this._el_38, 'button', new import84.InlineArray8(6, 'block', '', 'color', 'secondary', 'ion-button', ''), null);
        ...
        var disposable_1 = import84.subscribeToRenderElement(this, this._el_40, new import84.InlineArray2(2, 'click', null), this.eventHandler(this.handleEvent_40));
    ...
    View_ApiDemoPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import118.ListHeader) && ((13 <= requestNodeIndex) && (requestNodeIndex <= 14)))) {
            return this._ListHeader_13_4.context;
        }
        if (((token === import119.Label) && ((18 <= requestNodeIndex) && (requestNodeIndex <= 19)))) {
            return this._Label_18_3.context;
        }
        if (((token === import120.Option) && ((23 <= requestNodeIndex) && (requestNodeIndex <= 24)))) {
            return this._Option_23_3.context;
        }
        if (((token === import120.Option) && ((26 <= requestNodeIndex) && (requestNodeIndex <= 27)))) {
        ...
        if (((token === import100.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 43)))) {
...
export var View_PushPage0 = (function (_super) {
    ...
    View_PushPage0.prototype.createInternal = function (rootSelector) {
        ...
        this._text_7 = this.renderer.createText(this._el_0, '\n\n', null);
        this._text_8 = this.renderer.createText(parentRenderNode, '\n\n\n', null);
        this._el_9 = import84.createRenderElement(this.renderer, parentRenderNode, 'ion-content', new import84.InlineArray2(2, 'padding', ''), null);
        this.compView_9 = new import101.View_Content0(this.viewUtils, this, 9, this._el_9);
        this._Content_9_3 = new import101.Wrapper_Content(this.parentView.injectorGet(import67.Config, this.parentIndex), new import93.ElementRef(this._el_9), this.renderer, this.parentView.injectorGet(import12.App, this.parentIndex), this.parentView.injectorGet(import36.Keyboard, this.parentIndex), this.parentView.injectorGet(import58.NgZone, this.parentIndex), this.parentView.injectorGet(import91.ViewController, this.parentIndex, null), this.parentView.injectorGet(import116.Tabs, this.parentIndex, null), this.parentView.injectorGet(import10.DomController, this.parentIndex));
        this._text_10 = this.renderer.createText(null, '\n\n  ', null);
        this._el_11 = import84.createRenderElement(this.renderer, null, 'div', import84.EMPTY_INLINE_ARRAY, null);
        this._text_12 = this.renderer.createText(this._el_11, '\n    ', null);
        this._el_13 = import84.createRenderElement(this.renderer, this._el_11, 'h5', import84.EMPTY_INLINE_ARRAY, null);
        this._text_14 = this.renderer.createText(this._el_13, 'Parameters passed:', null);
        this._text_15 = this.renderer.createText(this._el_11, '\n\n    ', null);
        this._el_16 = import84.createRenderElement(this.renderer, this._el_11, 'pre', new import84.InlineArray2(2, 'style', 'background-color: #f8f8f8'), null);
    ...
    View_PushPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import100.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 19)))) {
            return this._Content_9_3.context;
        }
        return notFoundResult;
    };
    View_PushPage0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        this._Navbar_2_3.checkHost(this, this.compView_2, this._el_2, throwOnChange);
        this._Content_9_3.checkHost(this, this.compView_9, this._el_9, throwOnChange);
        var currVal_28 = import84.inlineInterpolate(1, 'selections: [\n  ', this.context.myParam, '\n]');

...
export class TableSearchPage {
  constructor(formBuilder) {
    ...
    this.form = formBuilder.group({searchQuery: ['', Validators.required]});
    this.query = 'HELLO';
    this.items = [];
    for (let i = 0; i < 100; i++) {
...
Object.defineProperty(TableSearchPage, "annotations", {get: function() {
...
Object.defineProperty(TableSearchPage, "parameters", {get: function() {
    return [[FormBuilder]];
  }});

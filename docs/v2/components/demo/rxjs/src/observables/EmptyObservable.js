System.register('rxjs/src/observables/EmptyObservable', ['../Observable'], function (_export) {
    'use strict';

    var Observable, EmptyObservable;
    ...
    return {
        ...
        execute: function () {
            EmptyObservable = (function (_Observable) {
                _inherits(EmptyObservable, _Observable);

                function EmptyObservable(scheduler) {
                    _classCallCheck(this, EmptyObservable);

                    _get(Object.getPrototypeOf(EmptyObservable.prototype), 'constructor', this).call(this);
            ...
            _export('default', EmptyObservable);
        }
    };
});
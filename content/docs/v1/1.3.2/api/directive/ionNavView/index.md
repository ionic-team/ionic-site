...
&nbsp;
<a href='https://github.com/ionic-team/ionic-v1/edit/master/js/angular/directive/navView.js#L1'>
Improve this doc
</a>
</div>
...
the <a href="/docs/v1/api/directive/ionNavBar/"><code>ionNavBar</code></a> directive that updates as we navigate through the
navigation stack.
...
<a href="/docs/v1/api/directive/ionView/"><code>ionView</code></a> scope, such as `$ionicView.enter`, may be useful.
...
<a href="/docs/v1/api/provider/$ionicConfigProvider/"><code>$ionicConfigProvider</code></a>:
...
The <a href="/docs/v1/api/provider/$ionicConfigProvider/"><code>$ionicConfigProvider</code></a> can be used to set the maximum allowable views

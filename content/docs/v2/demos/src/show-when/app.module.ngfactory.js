...
import * as import105 from '../components/show-hide-when/show-hide-when.ngfactory';
...
import * as import109 from '../components/show-hide-when/show-hide-when';
import * as import110 from '../components/grid/grid';
...
export var View_ApiDemoPage0 = (function (_super) {
    ...
    View_ApiDemoPage0.prototype.createInternal = function (rootSelector) {
        ...
        this._el_9 = import85.createRenderElement(this.renderer, parentRenderNode, 'ion-content', new import85.InlineArray2(2, 'class', 'show-when-demo'), null);
        ...
        this._el_11 = import85.createRenderElement(this.renderer, null, 'h5', new import85.InlineArray2(2, 'margin', ''), null);
        ...
        this._el_14 = import85.createRenderElement(this.renderer, null, 'p', new import85.InlineArray2(2, 'margin', ''), null);
        this._text_15 = this.renderer.createText(this._el_14, 'In this example we\'re using the ', null);
        this._el_16 = import85.createRenderElement(this.renderer, this._el_14, 'code', import85.EMPTY_INLINE_ARRAY, null);
        ...
        this._el_20 = import85.createRenderElement(this.renderer, null, 'ion-grid', import85.EMPTY_INLINE_ARRAY, null);
        this._Grid_20_3 = new import103.Wrapper_Grid();
        this._text_21 = this.renderer.createText(this._el_20, '\n    ', null);
        this._el_22 = import85.createRenderElement(this.renderer, this._el_20, 'ion-row', import85.EMPTY_INLINE_ARRAY, null);
        this._Row_22_3 = new import103.Wrapper_Row();
        this._text_23 = this.renderer.createText(this._el_22, '\n      ', null);
        this._el_24 = import85.createRenderElement(this.renderer, this._el_22, 'ion-col', new import85.InlineArray2(2, 'text-center', ''), null);
        this._Col_24_3 = new import103.Wrapper_Col();
        this._text_25 = this.renderer.createText(this._el_24, '\n        ', null);
        this._el_26 = import85.createRenderElement(this.renderer, this._el_24, 'ion-icon', new import85.InlineArray8(6, 'name', 'logo-apple', 'role', 'img', 'showWhen', 'ios'), null);
        ...
        this._ShowWhen_26_4 = new import105.Wrapper_ShowWhen('ios', this.parentView.injectorGet(import67.Platform, this.parentIndex), this.parentView.injectorGet(import59.NgZone, this.parentIndex));
        this._text_27 = this.renderer.createText(this._el_24, '\n      ', null);
        this._text_28 = this.renderer.createText(this._el_22, '\n      ', null);
        this._el_29 = import85.createRenderElement(this.renderer, this._el_22, 'ion-col', import85.EMPTY_INLINE_ARRAY, null);
        this._Col_29_3 = new import103.Wrapper_Col();
        this._text_30 = this.renderer.createText(this._el_29, '\n        ', null);
        this._el_31 = import85.createRenderElement(this.renderer, this._el_29, 'code', import85.EMPTY_INLINE_ARRAY, null);
        ...
        this._el_36 = import85.createRenderElement(this.renderer, this._el_20, 'ion-row', import85.EMPTY_INLINE_ARRAY, null);
        this._Row_36_3 = new import103.Wrapper_Row();
        this._text_37 = this.renderer.createText(this._el_36, '\n      ', null);
        this._el_38 = import85.createRenderElement(this.renderer, this._el_36, 'ion-col', new import85.InlineArray2(2, 'text-center', ''), null);
        this._Col_38_3 = new import103.Wrapper_Col();
        this._text_39 = this.renderer.createText(this._el_38, '\n        ', null);
        this._el_40 = import85.createRenderElement(this.renderer, this._el_38, 'ion-icon', new import85.InlineArray8(6, 'name', 'logo-android', 'role', 'img', 'showWhen', 'android'), null);
        this._Icon_40_3 = new import104.Wrapper_Icon(this.parentView.injectorGet(import68.Config, this.parentIndex), new import94.ElementRef(this._el_40), this.renderer);
        this._ShowWhen_40_4 = new import105.Wrapper_ShowWhen('android', this.parentView.injectorGet(import67.Platform, this.parentIndex), this.parentView.injectorGet(import59.NgZone, this.parentIndex));
        this._text_41 = this.renderer.createText(this._el_38, '\n      ', null);
        this._text_42 = this.renderer.createText(this._el_36, '\n      ', null);
        this._el_43 = import85.createRenderElement(this.renderer, this._el_36, 'ion-col', import85.EMPTY_INLINE_ARRAY, null);
        this._Col_43_3 = new import103.Wrapper_Col();
        this._text_44 = this.renderer.createText(this._el_43, '\n        ', null);
        this._el_45 = import85.createRenderElement(this.renderer, this._el_43, 'code', import85.EMPTY_INLINE_ARRAY, null);
        ...
        this._el_50 = import85.createRenderElement(this.renderer, this._el_20, 'ion-row', import85.EMPTY_INLINE_ARRAY, null);
        this._Row_50_3 = new import103.Wrapper_Row();
        this._text_51 = this.renderer.createText(this._el_50, '\n      ', null);
        this._el_52 = import85.createRenderElement(this.renderer, this._el_50, 'ion-col', new import85.InlineArray2(2, 'text-center', ''), null);
        this._Col_52_3 = new import103.Wrapper_Col();
        this._text_53 = this.renderer.createText(this._el_52, '\n        ', null);
        this._el_54 = import85.createRenderElement(this.renderer, this._el_52, 'ion-icon', new import85.InlineArray8(6, 'name', 'logo-windows', 'role', 'img', 'showWhen', 'windows'), null);
        this._Icon_54_3 = new import104.Wrapper_Icon(this.parentView.injectorGet(import68.Config, this.parentIndex), new import94.ElementRef(this._el_54), this.renderer);
        this._ShowWhen_54_4 = new import105.Wrapper_ShowWhen('windows', this.parentView.injectorGet(import67.Platform, this.parentIndex), this.parentView.injectorGet(import59.NgZone, this.parentIndex));
        this._text_55 = this.renderer.createText(this._el_52, '\n      ', null);
        this._text_56 = this.renderer.createText(this._el_50, '\n      ', null);
        this._el_57 = import85.createRenderElement(this.renderer, this._el_50, 'ion-col', import85.EMPTY_INLINE_ARRAY, null);
        this._Col_57_3 = new import103.Wrapper_Col();
        this._text_58 = this.renderer.createText(this._el_57, '\n        ', null);
        this._el_59 = import85.createRenderElement(this.renderer, this._el_57, 'code', import85.EMPTY_INLINE_ARRAY, null);
    ...
    View_ApiDemoPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import108.Icon) && (26 === requestNodeIndex))) {
            return this._Icon_26_3.context;
        }
        if (((token === import109.ShowWhen) && (26 === requestNodeIndex))) {
            return this._ShowWhen_26_4.context;
        }
        if (((token === import110.Col) && ((24 <= requestNodeIndex) && (requestNodeIndex <= 27)))) {
            return this._Col_24_3.context;
        }
        if (((token === import110.Col) && ((29 <= requestNodeIndex) && (requestNodeIndex <= 33)))) {
            return this._Col_29_3.context;
        }
        if (((token === import110.Row) && ((22 <= requestNodeIndex) && (requestNodeIndex <= 34)))) {
            return this._Row_22_3.context;
        }
        if (((token === import108.Icon) && (40 === requestNodeIndex))) {
            return this._Icon_40_3.context;
        }
        if (((token === import109.ShowWhen) && (40 === requestNodeIndex))) {
            return this._ShowWhen_40_4.context;
        }
        if (((token === import110.Col) && ((38 <= requestNodeIndex) && (requestNodeIndex <= 41)))) {
            return this._Col_38_3.context;
        }
        if (((token === import110.Col) && ((43 <= requestNodeIndex) && (requestNodeIndex <= 47)))) {
            return this._Col_43_3.context;
        }
        if (((token === import110.Row) && ((36 <= requestNodeIndex) && (requestNodeIndex <= 48)))) {
            return this._Row_36_3.context;
        }
        if (((token === import108.Icon) && (54 === requestNodeIndex))) {
            return this._Icon_54_3.context;
        }
        if (((token === import109.ShowWhen) && (54 === requestNodeIndex))) {
            return this._ShowWhen_54_4.context;
        }
        if (((token === import110.Col) && ((52 <= requestNodeIndex) && (requestNodeIndex <= 55)))) {
            return this._Col_52_3.context;
        }
        if (((token === import110.Col) && ((57 <= requestNodeIndex) && (requestNodeIndex <= 61)))) {
            return this._Col_57_3.context;
        }
        if (((token === import110.Row) && ((50 <= requestNodeIndex) && (requestNodeIndex <= 62)))) {
            return this._Row_50_3.context;
        }
        if (((token === import110.Grid) && ((20 <= requestNodeIndex) && (requestNodeIndex <= 63)))) {
            return this._Grid_20_3.context;
        }
        if (((token === import101.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 64)))) {
    ...
    View_ApiDemoPage0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        this._Grid_20_3.ngDoCheck(this, this._el_20, throwOnChange);
        this._Row_22_3.ngDoCheck(this, this._el_22, throwOnChange);
        this._Col_24_3.ngDoCheck(this, this._el_24, throwOnChange);
        var currVal_26_0_0 = 'logo-apple';
        this._Icon_26_3.check_name(currVal_26_0_0, throwOnChange, false);
        this._Icon_26_3.ngDoCheck(this, this._el_26, throwOnChange);
        this._ShowWhen_26_4.ngDoCheck(this, this._el_26, throwOnChange);
        this._Col_29_3.ngDoCheck(this, this._el_29, throwOnChange);
        this._Row_36_3.ngDoCheck(this, this._el_36, throwOnChange);
        this._Col_38_3.ngDoCheck(this, this._el_38, throwOnChange);
        var currVal_40_0_0 = 'logo-android';
        this._Icon_40_3.check_name(currVal_40_0_0, throwOnChange, false);
        this._Icon_40_3.ngDoCheck(this, this._el_40, throwOnChange);
        this._ShowWhen_40_4.ngDoCheck(this, this._el_40, throwOnChange);
        this._Col_43_3.ngDoCheck(this, this._el_43, throwOnChange);
        this._Row_50_3.ngDoCheck(this, this._el_50, throwOnChange);
        this._Col_52_3.ngDoCheck(this, this._el_52, throwOnChange);
        var currVal_54_0_0 = 'logo-windows';
        this._Icon_54_3.check_name(currVal_54_0_0, throwOnChange, false);
        this._Icon_54_3.ngDoCheck(this, this._el_54, throwOnChange);
        this._ShowWhen_54_4.ngDoCheck(this, this._el_54, throwOnChange);
        this._Col_57_3.ngDoCheck(this, this._el_57, throwOnChange);
        ...
        this._ShowWhen_26_4.checkHost(this, this, this._el_26, throwOnChange);
        this._Icon_40_3.checkHost(this, this, this._el_40, throwOnChange);
        this._ShowWhen_40_4.checkHost(this, this, this._el_40, throwOnChange);
        this._Icon_54_3.checkHost(this, this, this._el_54, throwOnChange);
        this._ShowWhen_54_4.checkHost(this, this, this._el_54, throwOnChange);

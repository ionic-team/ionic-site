...
So what is the difference between Cordova and PhoneGap? Adobe uses a helpful analogy: Cordova is to PhoneGap as [Blink](https://en.wikipedia.org/wiki/Blink_(layout_engine))  is to Chrome. PhoneGap is Cordova plus extra Adobe stuff.

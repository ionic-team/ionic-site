...
var _View_ApiDemoPage0 = (function (_super) {
    ...
    _View_ApiDemoPage0.prototype.createInternal = function (rootSelector) {
        ...
        var compView_26 = import15.viewFactory_Button0(this.viewUtils, this.injector(26), this._appEl_26);
        this._Button_26_4 = new import15.Wrapper_Button(null, '', this.parentInjector.get(import16.Config), new import17.ElementRef(this._el_26), this.renderer);
    ...
    _View_ApiDemoPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import28.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 28)))) {

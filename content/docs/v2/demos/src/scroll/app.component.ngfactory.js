...
var _View_ApiDemoPage0 = (function (_super) {
    ...
    _View_ApiDemoPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import26.Scroll) && ((11 <= requestNodeIndex) && (requestNodeIndex <= 14)))) {
            return this._Scroll_11_4.context;
        }
        if (((token === import27.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 15)))) {
    ...
    _View_ApiDemoPage0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        if (this._Scroll_11_4.detectChangesInternal(this, this._el_11, throwOnChange)) {
        ...
        var currVal_5 = this._Scroll_11_4.context.scrollX;
        if (import4.checkBinding(throwOnChange, this._expr_5, currVal_5)) {
            this.renderer.setElementClass(this._el_11, 'scroll-x', currVal_5);
            this._expr_5 = currVal_5;
        }
        var currVal_6 = this._Scroll_11_4.context.scrollY;
...
var _View_ApiDemoApp0 = (function (_super) {
    ...
    _View_ApiDemoApp0.prototype.createInternal = function (rootSelector) {
        ...
        this._Nav_0_4 = new import28.Wrapper_Nav(this.parentInjector.get(import17.ViewController, null), this.parentInjector.get(import29.NavControllerBase, null), this.parentInjector.get(import18.App), this.parentInjector.get(import15.Config), this.parentInjector.get(import21.Keyboard), new import16.ElementRef(this._el_0), this.parentInjector.get(import22.NgZone), this.renderer, this.parentInjector.get(import30.ComponentFactoryResolver), this.parentInjector.get(import31.GestureController), this.parentInjector.get(import32.TransitionController), this.parentInjector.get(import33.DeepLinker, null));

...
export var View_ApiDemoPage0 = (function (_super) {
    ...
    function View_ApiDemoPage0(viewUtils, parentView, parentIndex, parentElement) {
        ...
        this._arr_10 = import84.pureProxy5(function (p0, p1, p2, p3, p4) {
            return [
                p0,
                p1,
                p2,
    ...
    View_ApiDemoPage0.prototype.createInternal = function (rootSelector) {
        var parentRenderNode = this.renderer.createViewRoot(this.parentElement);
        this._el_0 = import84.createRenderElement(this.renderer, parentRenderNode, 'ion-slides', new import84.InlineArray4(4, 'loop', 'true', 'style', 'background-color: black'), null);
        this.compView_0 = new import96.View_Slides0(this.viewUtils, this, 0, this._el_0);
        this._Slides_0_3 = new import96.Wrapper_Slides(this.parentView.injectorGet(import67.Config, this.parentIndex), new import93.ElementRef(this._el_0), this.renderer);
        this._text_1 = this.renderer.createText(null, '\n  ', null);
        this._anchor_2 = this.renderer.createTemplateAnchor(null, null);
        this._vc_2 = new import97.ViewContainer(2, 0, this, this._anchor_2);
        this._TemplateRef_2_5 = new import99.TemplateRef_(this, 2, this._anchor_2);
        this._NgFor_2_6 = new import98.Wrapper_NgFor(this._vc_2.vcRef, this._TemplateRef_2_5, this.parentView.injectorGet(import77.IterableDiffers, this.parentIndex), this.ref);
    ...
    View_ApiDemoPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import99.TemplateRef) && (2 === requestNodeIndex))) {
            return this._TemplateRef_2_5;
        }
        if (((token === import100.NgFor) && (2 === requestNodeIndex))) {
            return this._NgFor_2_6.context;
        }
        if (((token === import95.Slides) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 3)))) {
...
var View_ApiDemoPage1 = (function (_super) {
    ...
    function View_ApiDemoPage1(viewUtils, parentView, parentIndex, parentElement, declaredViewContainer) {
        ...
        this._expr_6 = import87.UNINITIALIZED;
    }
    View_ApiDemoPage1.prototype.createInternal = function (rootSelector) {
        this._el_0 = import84.createRenderElement(this.renderer, null, 'ion-slide', import84.EMPTY_INLINE_ARRAY, null);
        this.compView_0 = new import96.View_Slide0(this.viewUtils, this, 0, this._el_0);
        this._Slide_0_3 = new import96.Wrapper_Slide(new import93.ElementRef(this._el_0), this.parentView._Slides_0_3.context);
        this._text_1 = this.renderer.createText(null, '\n    ', null);
        this._el_2 = import84.createRenderElement(this.renderer, null, 'img', import84.EMPTY_INLINE_ARRAY, null);
        this._text_3 = this.renderer.createText(null, '\n  ', null);
    ...
    View_ApiDemoPage1.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import95.Slide) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 3)))) {
    ...
    View_ApiDemoPage1.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        var currVal_6 = import84.inlineInterpolate(1, './slide', this.context.$implicit, '.jpeg');
        if (import84.checkBinding(throwOnChange, this._expr_6, currVal_6)) {
            this.renderer.setElementProperty(this._el_2, 'src', this.viewUtils.sanitizer.sanitize(import101.SecurityContext.URL, currVal_6));
